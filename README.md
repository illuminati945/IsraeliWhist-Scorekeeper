...
- 🎯 **Exact Bidding Score Engine**: Instant calculation of $+10 + \text{Bid}^2$ for successful contracts, exact $-10 \times |\text{diff}|$ penalties, and $+50 / -50$ for Pass (Zero) bids.
...
- 📊 **Rich Analytics & Trends**: Accuracy hit rates (%), pass success rates, aggressive bidding index, and SVG progression charts.
...
| :--- | :--- | :--- | :--- | :--- |
| **0 (Pass)** | 0 | Made | $+50$ flat bonus | **$+50$** |
| **0 (Pass)** | $\ge 1$ | Failed | $-50$ penalty | **$-50$** |
| **1** | 1 | Made | $+10 + 1^2$ | **$+11$** |
| **2** | 2 | Made | $+10 + 2^2$ | **$+14$** |
| **3** | 3 | Made | $+10 + 3^2$ | **$+19$** |
| **4** | 4 | Made | $+10 + 4^2$ | **$+26$** |
