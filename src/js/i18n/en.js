export const EN = {
  ...
  quickPickSub: 'Drag player cards to swap seats, or drag/tap below to assign.',
  emptySeatPlaceholder: '+ Choose Player',
  emptySeat: 'Empty Seat',
  clearSeat: 'Clear seat',
  clearAllSeats: 'Clear All',
  tapToSwapSeats: 'Drag card to swap',
  dragToSwapSeats: 'Drag to swap',
  mustChoose4Players: 'Please choose all 4 players to start the game',
  tableEmblem: '♠ ♥ ♦ ♣',
  seat1: 'Seat 1',
  seat2: 'Seat 2',
  seat3: 'Seat 3',
