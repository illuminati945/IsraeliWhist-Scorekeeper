var j={STANDARD:{id:"STANDARD",nameEn:"Standard Israeli Whist (Quadratic)",nameHe:"Standard Israeli Whist",descriptionEn:"Exact Made: +10 + Bid\xB2 | Miss: -10 \xD7 diff | Zero: +50 down / +30 up, -50 + 10/trick | Hook Rule: On",descriptionHe:"\u05DE\u05D3\u05D5\u05D9\u05E7: 10 + \u05D4\u05DB\u05E8\u05D6\u05D4\xB2 | \u05D4\u05D7\u05D8\u05D0\u05D4: 10- \u05DC\u05DB\u05DC \u05D4\u05E4\u05E8\u05E9 | \u05D0\u05E4\u05E1: 50+ \u05D1\u05D7\u05E1\u05E8 / 30+ \u05D1\u05D9\u05EA\u05E8, 50- \u05D5-10+ \u05DC\u05DB\u05DC \u05DC\u05E7\u05D9\u05D7\u05D4 \u05E0\u05D5\u05E1\u05E4\u05EA | \u05D7\u05D5\u05E7 \u05D4\u05D4\u05D5\u05E7",bidMadeFormula:"QUADRATIC",missPenaltyRate:10,useProgressivePenalty:!1,passMadeScoreDown:50,passMadeScoreUp:30,passMadeScore:50,passMissPenalty:50,passMissBonusPerTrick:10,pasRoundTrickPenalty:10,pasRoundZeroBonus:50,enforceHookRule:!0,trumpMakerMissDoublePenalty:!1},PROGRESSIVE:{id:"PROGRESSIVE",nameEn:"Progressive Penalty (Tournament)",nameHe:"Progressive Penalty (Tournament)",descriptionEn:"Exact Made: +10 + Bid\xB2 | Miss: -5/-10/-15/-20 per trick by bid | Zero: +50 down / +30 up, -50 + 10/trick",descriptionHe:"\u05DE\u05D3\u05D5\u05D9\u05E7: 10 + \u05D4\u05DB\u05E8\u05D6\u05D4\xB2 | \u05D4\u05D7\u05D8\u05D0\u05D4 \u05E4\u05E8\u05D5\u05D2\u05E8\u05E1\u05D9\u05D1\u05D9\u05EA \u05DC\u05E4\u05D9 \u05D4\u05DB\u05E8\u05D6\u05D4 | \u05D0\u05E4\u05E1: 50+ \u05D1\u05D7\u05E1\u05E8 / 30+ \u05D1\u05D9\u05EA\u05E8, 50- \u05D5-10+ \u05DC\u05DB\u05DC \u05DC\u05E7\u05D9\u05D7\u05D4 \u05E0\u05D5\u05E1\u05E4\u05EA",bidMadeFormula:"QUADRATIC",missPenaltyRate:10,useProgressivePenalty:!0,progressiveRates:{1:5,2:5,3:5,4:5,5:10,6:15,7:20},passMadeScoreDown:50,passMadeScoreUp:30,passMadeScore:50,passMissPenalty:50,passMissBonusPerTrick:10,pasRoundTrickPenalty:10,pasRoundZeroBonus:50,enforceHookRule:!0,trumpMakerMissDoublePenalty:!1},CLASSIC_LINEAR:{id:"CLASSIC_LINEAR",nameEn:"Classic Linear (10 + 10xBid)",nameHe:"Classic Linear (10 + 10xBid)",descriptionEn:"Exact Made: +10 + (Bid \xD7 10) | Miss: -10 \xD7 diff | Zero: +50 down / +30 up, -50 + 10/trick",descriptionHe:"\u05DE\u05D3\u05D5\u05D9\u05E7: 10 + (10 \xD7 \u05D4\u05DB\u05E8\u05D6\u05D4) | \u05D4\u05D7\u05D8\u05D0\u05D4: 10- \u05DC\u05DB\u05DC \u05D4\u05E4\u05E8\u05E9 | \u05D0\u05E4\u05E1: 50+ \u05D1\u05D7\u05E1\u05E8 / 30+ \u05D1\u05D9\u05EA\u05E8, 50- \u05D5-10+ \u05DC\u05DB\u05DC \u05DC\u05E7\u05D9\u05D7\u05D4 \u05E0\u05D5\u05E1\u05E4\u05EA",bidMadeFormula:"LINEAR_10",missPenaltyRate:10,useProgressivePenalty:!1,passMadeScoreDown:50,passMadeScoreUp:30,passMissPenalty:50,passMissBonusPerTrick:10,pasRoundTrickPenalty:10,pasRoundZeroBonus:50,enforceHookRule:!0,trumpMakerMissDoublePenalty:!1}},oe=[{id:"NT",symbol:"NT",nameEn:"No Trump",color:"#6366f1",rank:5},{id:"SPADES",symbol:"\u2660",nameEn:"Spades",color:"#94a3b8",rank:4},{id:"HEARTS",symbol:"\u2665",nameEn:"Hearts",color:"#f43f5e",rank:3},{id:"DIAMONDS",symbol:"\u2666",nameEn:"Diamonds",color:"#fbbf24",rank:2},{id:"CLUBS",symbol:"\u2663",nameEn:"Clubs",color:"#34d399",rank:1}];function F(w,e,s=!1,t=!1,i=j.STANDARD,n=13){if(t)if(e===0){let l=i.pasRoundZeroBonus||50;return{score:l,made:!0,delta:0,explanation:`0 tricks taken: +${l} bonus`}}else{let l=-(e*(i.pasRoundTrickPenalty||10));return{score:l,made:!1,delta:e,explanation:`${e} tricks taken \xD7 -${i.pasRoundTrickPenalty||10} = ${l}`}}if(w===e)if(w===0){let l=n>13,d=i.passMadeScoreDown??(i.passMadeScore||50),c=i.passMadeScoreUp??(i.passMadeScoreOver||30),m=l?c:d;return{score:m,made:!0,delta:0,explanation:`Bid 0 made (${l?"Up / \u05D9\u05EA\u05E8":"Down / \u05D7\u05E1\u05E8"}): +${m} pts`}}else{let l=0;return i.bidMadeFormula==="QUADRATIC"?l=10+w*w:i.bidMadeFormula==="LINEAR_10"?l=10+w*10:l=10+w*w,{score:l,made:!0,delta:0,explanation:`Bid ${w} made: 10 + (${w}\xB2) = +${l} pts`}}let a=Math.abs(e-w);if(w===0){let l=i.passMissPenalty??50,d=i.passMissBonusPerTrick??10,c=-l+(e-1)*d,m=e===1?`Bid 0 missed (1 trick): -${l} pts`:`Bid 0 missed (${e} tricks): -${l} + ${(e-1)*d} = ${c>=0?"+":""}${c} pts`;return{score:c,made:!1,delta:a,explanation:m}}let o=i.missPenaltyRate||10;if(i.useProgressivePenalty&&i.progressiveRates){let l=Math.min(Math.max(w,1),7);o=i.progressiveRates[l]||10}let r=-(a*o);return s&&i.trumpMakerMissDoublePenalty&&(r*=2),{score:r,made:!1,delta:a,explanation:`Bid ${w}, took ${e} (${a} diff \xD7 -${o}): ${r} pts`}}function W(w){let e=w.reduce((s,t)=>s+(typeof t=="number"&&!isNaN(t)?t:0),0);return w.length===4&&w.every(s=>typeof s=="number"&&!isNaN(s))?e===13?{isValid:!1,sum:e,status:"HOOK_VIOLATION"}:{isValid:!0,sum:e,status:e>13?"OVER":"UNDER"}:{isValid:!0,sum:e,status:e>13?"OVER":"UNDER"}}function le(w){return w.length!==4?!1:w.reduce((s,t)=>s+(typeof t=="number"&&!isNaN(t)?t:0),0)===13}var ae="israeli_whist_current_game_v2",_=class w{constructor(e={}){this.id=e.id||"game_"+Date.now(),this.createdAt=e.createdAt||new Date().toISOString(),this.rules=e.rules||{...j.STANDARD},this.targetPoints=e.targetPoints||null,this.maxRounds=e.maxRounds||null,this.simplifiedMode=e.simplifiedMode!==void 0?e.simplifiedMode:!0,this.players=e.players||[{id:"p0",name:"Player 1",color:"#6366f1",initial:"1"},{id:"p1",name:"Player 2",color:"#10b981",initial:"2"},{id:"p2",name:"Player 3",color:"#f59e0b",initial:"3"},{id:"p3",name:"Player 4",color:"#ec4899",initial:"4"}],this.currentDealerIndex=e.currentDealerIndex??0,this.roundNumber=e.roundNumber||1,this.completedRounds=e.completedRounds||[],this.initialScores=Array.isArray(e.initialScores)?e.initialScores.map(s=>parseInt(s,10)||0):[0,0,0,0],this.activeRound=e.activeRound||this.initDraftRound(),this.status=e.status||"IN_PROGRESS",this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(s=>s!==e)}}notify(){this.saveToStorage();for(let e of this.listeners)e(this)}initDraftRound(){let e=this.currentDealerIndex,s=(e+1)%4;return{roundNumber:this.roundNumber,dealerIndex:e,leadBidderIndex:s,stage:this.simplifiedMode?"BETS":"TRUMP",trump:{winnerIndex:null,suitId:"NT",bidAmount:0,isPasRound:!1},bets:[null,null,null,null],tricks:[null,null,null,null],scores:[0,0,0,0],roundTotalBets:0,bettingMode:null,timestamp:new Date().toISOString()}}setSimplifiedMode(e){this.simplifiedMode=e,this.activeRound&&(e&&this.activeRound.stage==="TRUMP"?this.activeRound.stage="BETS":!e&&this.activeRound.stage==="BETS"&&this.activeRound.bets.every(s=>s===null)&&(this.activeRound.stage="TRUMP")),this.notify()}getFirstBidderIndex(){return!this.simplifiedMode&&this.activeRound.trump.winnerIndex!==null&&!this.activeRound.trump.isPasRound?this.activeRound.trump.winnerIndex:(this.currentDealerIndex+1)%4}getLastBidderIndex(){return this.simplifiedMode?null:(this.getFirstBidderIndex()+3)%4}getBiddingOrder(){let e=this.getFirstBidderIndex();return[e,(e+1)%4,(e+2)%4,(e+3)%4]}getForbiddenBetForLastBidder(){if(this.simplifiedMode)return null;let e=this.getLastBidderIndex();if(e===null)return null;let s=[];for(let t=0;t<4;t++)t!==e&&typeof this.activeRound.bets[t]=="number"&&!isNaN(this.activeRound.bets[t])&&s.push(this.activeRound.bets[t]);if(s.length===3){let i=13-s.reduce((n,a)=>n+a,0);if(i>=0&&i<=13)return i}return null}setTrump(e,s,t,i=!1){this.activeRound.trump={winnerIndex:i?null:e,suitId:i?"NT":s,bidAmount:i?0:t,isPasRound:i},!i&&e!==null&&typeof e=="number"&&(this.activeRound.bets[e]===null||this.activeRound.bets[e]<t)&&(this.activeRound.bets[e]=t),this.activeRound.stage="BETS",this.notify()}setBet(e,s){if(e<0||e>3)return;this.activeRound.bets[e]=s;let t=this.activeRound.bets.filter(n=>typeof n=="number"&&!isNaN(n)),i=t.reduce((n,a)=>n+a,0);if(this.activeRound.roundTotalBets=i,t.length===4){let n=W(this.activeRound.bets);this.activeRound.bettingMode=n.status}else this.activeRound.bettingMode=i>13?"OVER":"UNDER";this.notify()}proceedToTricks(){if(this.activeRound.bets.filter(s=>typeof s=="number"&&!isNaN(s)).length!==4&&!this.activeRound.trump.isPasRound)throw new Error("All 4 players must submit bets.");if(this.rules.enforceHookRule&&!this.activeRound.trump.isPasRound&&!W(this.activeRound.bets).isValid)throw new Error("Total bets cannot equal 13 (Hook Rule). Please adjust the bids.");this.activeRound.stage="TRICKS",this.notify()}setTricks(e,s){e<0||e>3||(this.activeRound.tricks[e]=s,this.notify())}autoFillTricksFromBids(){let e=[],s=-1;for(let t=0;t<4;t++)typeof this.activeRound.tricks[t]=="number"&&!isNaN(this.activeRound.tricks[t])?e.push(this.activeRound.tricks[t]):s=t;if(e.length===3&&s!==-1){let t=13-e.reduce((i,n)=>i+n,0);if(t>=0&&t<=13)return this.activeRound.tricks[s]=t,this.notify(),!0}for(let t=0;t<4;t++){let i=this.activeRound.bets[t];this.activeRound.tricks[t]=typeof i=="number"&&!isNaN(i)?i:0}return this.notify(),!0}commitRound(){let e=this.activeRound.tricks;if(!le(e))throw new Error("Total tricks must equal 13.");let s=[],t=this.activeRound.trump.isPasRound,i=this.activeRound.bets.reduce((a,o)=>a+(typeof o=="number"?o:0),0);for(let a=0;a<4;a++){let o=t?0:this.activeRound.bets[a],r=e[a],l=a===this.activeRound.trump.winnerIndex,d=F(o,r,l,t,this.rules,i);s.push({playerIndex:a,bid:o,tricks:r,score:d.score,made:d.made,delta:d.delta,explanation:d.explanation})}let n={...this.activeRound,simplified:this.simplifiedMode,results:s,scores:s.map(a=>a.score),cumulativeScores:this.calculateCumulativeAfterRound(s.map(a=>a.score)),completedAt:new Date().toISOString()};return this.completedRounds.push(n),this.checkGameEnd(),this.status!=="FINISHED"&&(this.currentDealerIndex=(this.currentDealerIndex+1)%4,this.roundNumber+=1,this.activeRound=this.initDraftRound()),this.notify(),n}calculateCumulativeAfterRound(e){return this.getCumulativeScores().map((t,i)=>t+e[i])}getCumulativeScores(){let e=[...this.initialScores];for(let s of this.completedRounds)for(let t=0;t<4;t++)e[t]+=s.scores&&typeof s.scores[t]=="number"?s.scores[t]:0;return e}setInitialScores(e){Array.isArray(e)&&e.length===4&&(this.initialScores=e.map(s=>parseInt(s,10)||0),this.recalculateAllScores())}recalculateAllScores(){let e=[...this.initialScores];for(let s=0;s<this.completedRounds.length;s++){let t=this.completedRounds[s],i=t.trump&&t.trump.isPasRound,n=r=>!t.simplified&&t.trump&&t.trump.winnerIndex===r,a=(t.bets||[]).reduce((r,l)=>r+(typeof l=="number"?l:0),0),o=[];for(let r=0;r<4;r++){let l=t.bets&&typeof t.bets[r]=="number"?t.bets[r]:0,d=t.tricks&&typeof t.tricks[r]=="number"?t.tricks[r]:0,c=F(l,d,n(r),i,this.rules,a);o.push({playerIndex:r,bid:l,tricks:d,score:c.score,made:c.made,explanation:c.explanation})}t.results=o,t.scores=o.map(r=>r.score),t.roundTotalBets=a,e=e.map((r,l)=>r+t.scores[l]),t.cumulativeScores=[...e]}this.checkGameEnd(),this.notify()}editCompletedRound(e,s={}){if(e<0||e>=this.completedRounds.length)throw new Error(`Invalid round index: ${e}`);let t=this.completedRounds[e];if(Array.isArray(s.bets)&&(t.bets=s.bets.map(i=>parseInt(i,10)||0),t.roundTotalBets=t.bets.reduce((i,n)=>i+n,0)),Array.isArray(s.tricks)){t.tricks=s.tricks.map(n=>parseInt(n,10)||0);let i=t.tricks.reduce((n,a)=>n+a,0);if(i!==13)throw new Error(`Total tricks must equal 13 (sum is ${i})`)}return s.dealerIndex!==void 0&&s.dealerIndex>=0&&s.dealerIndex<4&&(t.dealerIndex=s.dealerIndex,t.leadBidderIndex=(t.dealerIndex+1)%4),s.trump&&(t.trump={...t.trump,...s.trump}),this.recalculateAllScores(),t}deleteCompletedRound(e){if(e<0||e>=this.completedRounds.length)throw new Error(`Invalid round index: ${e}`);this.completedRounds.splice(e,1),this.completedRounds.forEach((s,t)=>{s.roundNumber=t+1}),this.roundNumber=this.completedRounds.length+1,this.activeRound&&(this.activeRound.roundNumber=this.roundNumber),this.recalculateAllScores()}getRankings(){let e=this.getCumulativeScores();return this.players.map((s,t)=>({index:t,player:s,score:e[t]})).sort((s,t)=>t.score-s.score)}checkGameEnd(){if(this.maxRounds&&this.completedRounds.length>=this.maxRounds){this.status="FINISHED";return}this.targetPoints&&this.getCumulativeScores().some(s=>s>=this.targetPoints)&&(this.status="FINISHED")}undoLastRound(){if(this.completedRounds.length===0)return!1;let e=this.completedRounds.pop();return this.roundNumber=e.roundNumber,this.currentDealerIndex=e.dealerIndex,this.activeRound={roundNumber:e.roundNumber,dealerIndex:e.dealerIndex,leadBidderIndex:e.leadBidderIndex,stage:"TRICKS",trump:{...e.trump},bets:[...e.bets],tricks:[...e.tricks],scores:[0,0,0,0],roundTotalBets:e.roundTotalBets,bettingMode:e.bettingMode,timestamp:e.timestamp},this.status="IN_PROGRESS",this.notify(),!0}updatePlayer(e,s,t){e>=0&&e<4&&(this.players[e]={...this.players[e],name:s||this.players[e].name,color:t||this.players[e].color},this.notify())}reorderPlayers(e){if(!Array.isArray(e)||e.length!==4)return;let s=[...this.players];this.players=e.map(i=>s[i]);let t=i=>i!=null&&i>=0&&i<4?e.indexOf(i):i;if(this.currentDealerIndex=t(this.currentDealerIndex),this.activeRound){if(this.activeRound.dealerIndex=t(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=t(this.activeRound.trump.winnerIndex)),Array.isArray(this.activeRound.bets)&&this.activeRound.bets.length===4){let i=[...this.activeRound.bets];this.activeRound.bets=e.map(n=>i[n])}if(Array.isArray(this.activeRound.tricks)&&this.activeRound.tricks.length===4){let i=[...this.activeRound.tricks];this.activeRound.tricks=e.map(n=>i[n])}if(Array.isArray(this.activeRound.scores)&&this.activeRound.scores.length===4){let i=[...this.activeRound.scores];this.activeRound.scores=e.map(n=>i[n])}}for(let i of this.completedRounds){if(i.dealerIndex=t(i.dealerIndex),i.leadBidderIndex!==void 0&&(i.leadBidderIndex=t(i.leadBidderIndex)),i.trump&&i.trump.winnerIndex!==null&&(i.trump.winnerIndex=t(i.trump.winnerIndex)),Array.isArray(i.scores)&&i.scores.length===4){let n=[...i.scores];i.scores=e.map(a=>n[a])}if(Array.isArray(i.cumulativeScores)&&i.cumulativeScores.length===4){let n=[...i.cumulativeScores];i.cumulativeScores=e.map(a=>n[a])}if(Array.isArray(i.results))for(let n of i.results)n.playerIndex=t(n.playerIndex)}if(Array.isArray(this.initialScores)&&this.initialScores.length===4){let i=[...this.initialScores];this.initialScores=e.map(n=>i[n])}this.notify()}swapPlayers(e,s){if(e===s||e<0||e>3||s<0||s>3)return;let t=this.players[e];if(this.players[e]=this.players[s],this.players[s]=t,Array.isArray(this.initialScores)&&this.initialScores.length===4){let n=this.initialScores[e];this.initialScores[e]=this.initialScores[s],this.initialScores[s]=n}let i=n=>n===e?s:n===s?e:n;if(this.currentDealerIndex=i(this.currentDealerIndex),this.activeRound){this.activeRound.dealerIndex=i(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=i(this.activeRound.trump.winnerIndex));let n=a=>{if(Array.isArray(a)&&a.length===4){let o=a[e];a[e]=a[s],a[s]=o}};n(this.activeRound.bets),n(this.activeRound.tricks),n(this.activeRound.scores)}for(let n of this.completedRounds){if(n.dealerIndex=i(n.dealerIndex),n.leadBidderIndex!==void 0&&(n.leadBidderIndex=i(n.leadBidderIndex)),n.trump&&n.trump.winnerIndex!==null&&(n.trump.winnerIndex=i(n.trump.winnerIndex)),Array.isArray(n.scores)&&n.scores.length===4){let a=n.scores[e];n.scores[e]=n.scores[s],n.scores[s]=a}if(Array.isArray(n.cumulativeScores)&&n.cumulativeScores.length===4){let a=n.cumulativeScores[e];n.cumulativeScores[e]=n.cumulativeScores[s],n.cumulativeScores[s]=a}if(Array.isArray(n.results))for(let a of n.results)a.playerIndex=i(a.playerIndex)}this.notify()}rotateSeatingClockwise(){let e=this.players[3];this.players=[e,this.players[0],this.players[1],this.players[2]];let s=t=>t!=null?(t+1)%4:t;if(this.currentDealerIndex=s(this.currentDealerIndex),this.activeRound){this.activeRound.dealerIndex=s(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=s(this.activeRound.trump.winnerIndex));let t=i=>[i[3],i[0],i[1],i[2]];this.activeRound.bets=t(this.activeRound.bets),this.activeRound.tricks=t(this.activeRound.tricks),this.activeRound.scores=t(this.activeRound.scores)}for(let t of this.completedRounds)if(t.dealerIndex=s(t.dealerIndex),t.leadBidderIndex!==void 0&&(t.leadBidderIndex=s(t.leadBidderIndex)),t.trump&&t.trump.winnerIndex!==null&&(t.trump.winnerIndex=s(t.trump.winnerIndex)),Array.isArray(t.scores)&&(t.scores=[t.scores[3],t.scores[0],t.scores[1],t.scores[2]]),Array.isArray(t.cumulativeScores)&&(t.cumulativeScores=[t.cumulativeScores[3],t.cumulativeScores[0],t.cumulativeScores[1],t.cumulativeScores[2]]),Array.isArray(t.results))for(let i of t.results)i.playerIndex=s(i.playerIndex);this.notify()}rotateSeatingCounterClockwise(){let e=this.players[0];this.players=[this.players[1],this.players[2],this.players[3],e];let s=t=>t!=null?(t+3)%4:t;if(this.currentDealerIndex=s(this.currentDealerIndex),this.activeRound){this.activeRound.dealerIndex=s(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=s(this.activeRound.trump.winnerIndex));let t=i=>[i[1],i[2],i[3],i[0]];this.activeRound.bets=t(this.activeRound.bets),this.activeRound.tricks=t(this.activeRound.tricks),this.activeRound.scores=t(this.activeRound.scores)}for(let t of this.completedRounds)if(t.dealerIndex=s(t.dealerIndex),t.leadBidderIndex!==void 0&&(t.leadBidderIndex=s(t.leadBidderIndex)),t.trump&&t.trump.winnerIndex!==null&&(t.trump.winnerIndex=s(t.trump.winnerIndex)),Array.isArray(t.scores)&&(t.scores=[t.scores[1],t.scores[2],t.scores[3],t.scores[0]]),Array.isArray(t.cumulativeScores)&&(t.cumulativeScores=[t.cumulativeScores[1],t.cumulativeScores[2],t.cumulativeScores[3],t.cumulativeScores[0]]),Array.isArray(t.results))for(let i of t.results)i.playerIndex=s(i.playerIndex);this.notify()}saveToStorage(){if(!(typeof localStorage>"u"))try{let e=JSON.stringify({id:this.id,createdAt:this.createdAt,rules:this.rules,targetPoints:this.targetPoints,maxRounds:this.maxRounds,simplifiedMode:this.simplifiedMode,players:this.players,currentDealerIndex:this.currentDealerIndex,roundNumber:this.roundNumber,completedRounds:this.completedRounds,initialScores:this.initialScores,activeRound:this.activeRound,status:this.status});localStorage.setItem(ae,e)}catch(e){console.warn("LocalStorage save failed:",e)}}static loadFromStorage(){if(typeof localStorage>"u")return new w;try{let e=localStorage.getItem(ae);if(e){let s=JSON.parse(e);return new w(s)}}catch(e){console.warn("LocalStorage load failed:",e)}return new w}static clearStorage(){if(!(typeof localStorage>"u"))try{localStorage.removeItem(ae)}catch(e){console.warn("LocalStorage clear failed:",e)}}exportJson(){return JSON.stringify({app:"Israeli Whist Scorekeeper",version:"1.0.0",exportedAt:new Date().toISOString(),session:{id:this.id,createdAt:this.createdAt,rules:this.rules,targetPoints:this.targetPoints,maxRounds:this.maxRounds,simplifiedMode:this.simplifiedMode,players:this.players,initialScores:this.initialScores,completedRounds:this.completedRounds,scores:this.getCumulativeScores(),rankings:this.getRankings()}},null,2)}};var Y=class{constructor(e,s){this.app=e,this.onRemoteUpdate=s,this.roomId=this.detectRoomIdFromUrl(),this.ws=null,this.connected=!1,this.userCount=1,this.listeners=[],this.isApplyingRemote=!1,this.init()}detectRoomIdFromUrl(){let e=new URLSearchParams(window.location.search),s=e.get("game")||e.get("room");return!s&&window.location.hash&&(s=window.location.hash.replace("#","").trim()),s||this.generateFallbackCode()}generateFallbackCode(){let e="23456789ABCDEFGHJKLMNPQRSTUVWXYZ",s="";for(let t=0;t<4;t++)s+=e.charAt(Math.floor(Math.random()*e.length));return`W-${s}`}updateUrl(e){if(!e)return;let s=new URL(window.location.href);s.searchParams.set("game",e),window.history.replaceState({roomId:e},"",s.toString())}getShareUrl(){let e=new URL(window.location.href);return e.searchParams.set("game",this.roomId),e.toString()}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(s=>s!==e)}}notify(){for(let e of this.listeners)e({roomId:this.roomId,connected:this.connected,userCount:this.userCount,shareUrl:this.getShareUrl()})}init(){this.connectWebSocket()}connectWebSocket(){let e=window.location,s=e.protocol==="https:"?"wss:":"ws:",t="";e.pathname.startsWith("/whist-dev")?t="/whist-dev":e.pathname.startsWith("/whist")&&(t="/whist");let i=`${s}//${e.host}${t}/ws`;try{this.ws=new WebSocket(i),this.ws.onopen=()=>{this.connected=!0,this.notify(),this.joinRoom(this.roomId)},this.ws.onmessage=n=>{try{let a=JSON.parse(n.data);this.handleMessage(a)}catch(a){console.warn("Sync parse error:",a)}},this.ws.onclose=()=>{this.connected=!1,this.notify(),setTimeout(()=>this.connectWebSocket(),3e3)},this.ws.onerror=n=>{console.warn("WebSocket connection error:",n),this.connected=!1,this.notify()}}catch(n){console.warn("WebSocket init error:",n)}}joinRoom(e){this.roomId=e,this.updateUrl(e),this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify({type:"JOIN",roomId:e})),this.notify()}createNewRoom(){let e=this.generateFallbackCode();return this.roomId=e,this.updateUrl(e),this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify({type:"JOIN",roomId:e})),this.notify(),e}hasMeaningfulLocalState(){if(!this.app||!this.app.session)return!1;let e=this.app.session;if(e.completedRounds&&e.completedRounds.length>0||e.initialScores&&e.initialScores.some(i=>i!==0))return!0;let s=(i,n)=>!i||i===`Player ${n+1}`||i===`\u05E9\u05D7\u05E7\u05DF ${n+1}`;return!!((e.players||[]).some((i,n)=>!s(i.name,n))||e.activeRound&&(e.activeRound.bets&&e.activeRound.bets.some(i=>i!==null)||e.activeRound.tricks&&e.activeRound.tricks.some(i=>i!==null)))}handleMessage(e){e.type==="JOINED"?(this.userCount=e.userCount||1,this.notify(),e.state?(this.isApplyingRemote=!0,this.onRemoteUpdate(e.state),this.isApplyingRemote=!1):this.hasMeaningfulLocalState()&&this.broadcastLocalState()):e.type==="USER_COUNT_CHANGED"?(this.userCount=e.userCount||1,this.notify()):e.type==="STATE_UPDATED"&&(e.state&&(this.isApplyingRemote=!0,this.onRemoteUpdate(e.state),this.isApplyingRemote=!1),e.userCount&&(this.userCount=e.userCount,this.notify()))}broadcastLocalState(){if(this.isApplyingRemote||!this.ws||this.ws.readyState!==WebSocket.OPEN||!this.hasMeaningfulLocalState())return;let e={id:this.app.session.id,createdAt:this.app.session.createdAt,rules:this.app.session.rules,targetPoints:this.app.session.targetPoints,maxRounds:this.app.session.maxRounds,simplifiedMode:this.app.session.simplifiedMode,players:this.app.session.players,currentDealerIndex:this.app.session.currentDealerIndex,roundNumber:this.app.session.roundNumber,completedRounds:this.app.session.completedRounds,initialScores:this.app.session.initialScores,activeRound:this.app.session.activeRound,status:this.app.session.status};this.ws.send(JSON.stringify({type:"SYNC_STATE",roomId:this.roomId,state:e}))}switchRoom(e){this.joinRoom(e)}};var Z="israeli_whist_recent_games_v1";var O=[],M=class{static getRecentGames(){if(O&&O.length>0)return O;if(typeof localStorage>"u")return[];try{let e=localStorage.getItem(Z);if(e)return O=JSON.parse(e),O}catch(e){console.warn("Failed to read recent games archive:",e)}return[]}static getBasePath(){if(typeof window>"u")return"";let e=window.location;return e.pathname.startsWith("/whist-dev")?"/whist-dev":e.pathname.startsWith("/whist")?"/whist":""}static async syncWithServer(e=null){try{let t=`${this.getBasePath()}/api/recent-games`,i=await fetch(t);if(i.ok){let n=await i.json();if(n&&n.success&&Array.isArray(n.games)){let a=n.games,o=this.getRecentGames(),r=new Map;o.forEach(d=>{d&&d.roomId&&r.set(d.roomId,d)}),a.forEach(d=>{d&&d.roomId&&r.set(d.roomId,d)});let l=Array.from(r.values()).sort((d,c)=>new Date(c.updatedAt||c.createdAt)-new Date(d.updatedAt||d.createdAt)).slice(0,10);if(O=l,typeof localStorage<"u")try{localStorage.setItem(Z,JSON.stringify(l))}catch{}return e&&e(l),l}}}catch(t){console.warn("Error syncing recent games with server:",t)}let s=this.getRecentGames();return e&&e(s),s}static saveGameToArchive(e,s){if(!e)return;let t=e.completedRounds?e.completedRounds.length:0,i=(r,l)=>!r||r===`Player ${l+1}`||r===`\u05E9\u05D7\u05E7\u05DF ${l+1}`,n=(e.players||[]).some((r,l)=>!i(r.name,l)),a=e.initialScores&&e.initialScores.some(r=>r!==0),o=e.activeRound&&(e.activeRound.bets&&e.activeRound.bets.some(r=>r!==null)||e.activeRound.tricks&&e.activeRound.tricks.some(r=>r!==null));if(!(t===0&&!n&&!o&&!a))try{let r=this.getRecentGames(),l=e.getCumulativeScores(),d=e.getRankings(),c=d.length>0?d[0]:null,m={roomId:s||e.id||"W-LOCAL",id:e.id,createdAt:e.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString(),roundNumber:e.roundNumber,completedRoundsCount:e.completedRounds?e.completedRounds.length:0,status:e.status||"IN_PROGRESS",simplifiedMode:e.simplifiedMode,players:e.players.map((f,g)=>({name:f.name,color:f.color,score:l[g]||0})),leaderName:c?c.player.name:e.players[0].name,leaderScore:c?c.score:0,fullState:{id:e.id,createdAt:e.createdAt,rules:e.rules,targetPoints:e.targetPoints,maxRounds:e.maxRounds,simplifiedMode:e.simplifiedMode,players:e.players,currentDealerIndex:e.currentDealerIndex,roundNumber:e.roundNumber,completedRounds:e.completedRounds,initialScores:e.initialScores,activeRound:e.activeRound,status:e.status}},p=r.filter(f=>f.roomId!==m.roomId&&f.id!==m.id),u=[m,...p].slice(0,10);O=u,typeof localStorage<"u"&&localStorage.setItem(Z,JSON.stringify(u));let y=`${this.getBasePath()}/api/session/${m.roomId}`;fetch(y,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(m.fullState)}).then(f=>f.json()).then(f=>{f&&f.rejected&&f.session&&typeof window<"u"&&window.__ISRAELI_WHIST_APP__&&(console.warn("[Sync] Server had an authoritative session; restoring state locally."),window.__ISRAELI_WHIST_APP__.applyRemoteState(f.session))}).catch(()=>{})}catch(r){console.warn("Failed to save game to archive:",r)}}static deleteGame(e){try{let t=this.getRecentGames().filter(n=>n.roomId!==e&&n.id!==e);O=t,typeof localStorage<"u"&&localStorage.setItem(Z,JSON.stringify(t));let i=`${this.getBasePath()}/api/delete-session/${e}`;fetch(i).catch(()=>{})}catch(s){console.warn("Failed to delete game from archive:",s)}}static formatTimestamp(e){if(!e)return"";try{let s=new Date(e),t=new Date,i=s.toDateString()===t.toDateString(),n=s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return i?`Today at ${n}`:`${s.toLocaleDateString([],{month:"short",day:"numeric"})} \u2022 ${n}`}catch{return e}}};var de="israeli_whist_profiles_v1",ce="israeli_whist_last_lineup_v1",L=["\u{1F98A}","\u{1F981}","\u{1F42F}","\u{1F43C}","\u{1F428}","\u{1F985}","\u{1F989}","\u{1F43A}","\u{1F451}","\u{1F0CF}","\u{1F680}","\u2B50","\u{1F525}","\u26A1","\u{1F48E}","\u{1F3AF}","\u{1F3A9}","\u{1F984}","\u{1F432}","\u{1F431}","\u{1F436}","\u{1F355}","\u{1F3AE}","\u{1F3C6}"],B=["#6366f1","#ec4899","#10b981","#f59e0b","#06b6d4","#8b5cf6","#ef4444","#14b8a6","#f97316","#3b82f6"],me=[{id:"prof_default_1",name:"\u05E2\u05D5\u05DE\u05E8",avatar:"\u{1F98A}",color:"#6366f1",gamesPlayed:5,wins:2,totalScore:320,zeroBids:4,zeroHits:3,lastPlayed:"2026-09-03T10:00:00Z"},{id:"prof_default_2",name:"\u05D3\u05E0\u05D9\u05D0\u05DC",avatar:"\u{1F981}",color:"#ec4899",gamesPlayed:5,wins:1,totalScore:210,zeroBids:3,zeroHits:2,lastPlayed:"2026-09-03T10:00:00Z"},{id:"prof_default_3",name:"\u05D8\u05DC",avatar:"\u{1F451}",color:"#10b981",gamesPlayed:5,wins:1,totalScore:195,zeroBids:2,zeroHits:2,lastPlayed:"2026-09-03T10:00:00Z"},{id:"prof_default_4",name:"\u05DE\u05D9\u05D4",avatar:"\u2B50",color:"#f59e0b",gamesPlayed:5,wins:1,totalScore:180,zeroBids:1,zeroHits:1,lastPlayed:"2026-09-03T10:00:00Z"}],V=null,C=class{static getProfiles(){if(V)return V;let e=[];if(typeof localStorage<"u")try{let s=localStorage.getItem(de);if(s){let t=JSON.parse(s);Array.isArray(t)&&t.length>0&&(e=t)}}catch(s){console.warn("Failed to parse saved profiles from localStorage:",s)}if(!e||e.length===0){let s=new Set;try{let t=typeof localStorage<"u"?JSON.parse(localStorage.getItem("israeli_whist_recent_games_v1")||"[]"):[];Array.isArray(t)&&t.forEach(i=>{i&&Array.isArray(i.players)&&i.players.forEach(n=>{n&&n.name&&!s.has(n.name.trim().toLowerCase())&&(s.add(n.name.trim().toLowerCase()),e.push({id:`prof_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,name:n.name.trim(),avatar:n.avatar||L[e.length%L.length],color:n.color||B[e.length%B.length],gamesPlayed:1,wins:0,totalScore:n.score||0,zeroBids:0,zeroHits:0,lastPlayed:i.updatedAt||new Date().toISOString()}))})})}catch{}e.length===0&&(e=[...me]),this.saveToStorage(e)}return V=e,V}static getProfile(e){return this.getProfiles().find(t=>t.id===e)||null}static getProfileByName(e){if(!e)return null;let s=e.trim().toLowerCase();return this.getProfiles().find(i=>i.name.trim().toLowerCase()===s)||null}static saveProfile(e){let s=this.getProfiles(),t=new Date().toISOString(),i=-1;e.id?i=s.findIndex(a=>a.id===e.id):e.name&&(i=s.findIndex(a=>a.name.trim().toLowerCase()===e.name.trim().toLowerCase()));let n=null;if(i>=0)s[i]={...s[i],...e,name:e.name.trim(),avatar:e.avatar||s[i].avatar||"\u{1F98A}",color:e.color||s[i].color||B[i%B.length],lastPlayed:t},n=s[i];else{let o={id:e.id||`prof_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,name:e.name.trim(),avatar:e.avatar||L[s.length%L.length],color:e.color||B[s.length%B.length],gamesPlayed:e.gamesPlayed||0,wins:e.wins||0,totalScore:e.totalScore||0,zeroBids:e.zeroBids||0,zeroHits:e.zeroHits||0,lastPlayed:t};s.unshift(o),n=o}return this.saveToStorage(s),n}static deleteProfile(e){let s=this.getProfiles();s=s.filter(t=>t.id!==e),this.saveToStorage(s)}static recordGameCompletion(e){if(!e||!e.players||!e.completedRounds||e.completedRounds.length===0)return;let t=e.completedRounds[e.completedRounds.length-1].cumulativeScores||[0,0,0,0],i=-1/0,n=0;t.forEach((o,r)=>{o>i&&(i=o,n=r)});let a=e.players.map((o,r)=>({name:o.name,color:o.color,avatar:o.avatar||this.getProfileByName(o.name)?.avatar||L[r%L.length]}));this.saveLastLineup(a),e.players.forEach((o,r)=>{let l=this.getProfileByName(o.name);l||(l=this.saveProfile({name:o.name,color:o.color,avatar:o.avatar||L[r%L.length]}));let d=0,c=0;e.completedRounds.forEach(m=>{(m.bets||m.bids||[])[r]===0&&(d++,m.tricks&&m.tricks[r]===0&&c++)}),l.gamesPlayed=(l.gamesPlayed||0)+1,r===n&&(l.wins=(l.wins||0)+1),l.totalScore=(l.totalScore||0)+t[r],l.zeroBids=(l.zeroBids||0)+d,l.zeroHits=(l.zeroHits||0)+c,l.lastPlayed=new Date().toISOString()}),this.saveToStorage(V)}static getLastLineup(){if(typeof localStorage>"u")return null;try{let e=localStorage.getItem(ce);if(e)return JSON.parse(e)}catch(e){console.warn("Failed to get last lineup:",e)}return null}static saveLastLineup(e){if(!(typeof localStorage>"u"||!Array.isArray(e)))try{localStorage.setItem(ce,JSON.stringify(e))}catch{}}static saveToStorage(e){if(V=e,typeof localStorage<"u")try{localStorage.setItem(de,JSON.stringify(e))}catch(s){console.warn("Failed to save profiles to localStorage:",s)}}};var Q=class{constructor(e,s){this.app=e,this.container=s}render(){if(!this.container)return;let e=this.app.i18n,s=e.lang==="he",t=M.getRecentGames(),i=C.getProfiles(),n=`
    ...
    `}renderBetsStage(e,s){let t=this.i18n,i=this.session.getLastBidderIndex(),n=i!==null?this.session.players[i]:null,a=this.session.getForbiddenBetForLastBidder(),o=W(e.bets),r=e.bets.reduce((p,u)=>p+(typeof u=="number"&&!isNaN(u)?u:0),0),l=e.bets.every(p=>typeof p=="number"&&!isNaN(p)),d=this.session.players[e.dealerIndex],c=e.trump.winnerIndex!==null?this.session.players[e.trump.winnerIndex]:null,m="";return s?l&&r===13?m=t.hookViolation:m=`${t.totalBids}: <strong>${r}</strong> (${r>13?t.over:r<13?t.under:"13"})`:a!==null&&n?m=`${t.totalBids}: <strong>${r}</strong> \u2022 ${t.lastBidder} (${n.name}) ${t.lastBidderCannotBid} <strong>${a}</strong>`:m=`${t.totalBids}: <strong>${r}</strong> (${o.status==="OVER"?t.over:o.status==="UNDER"?t.under:"13"})`,`
      <div>
        ...
        <div class="round-inputs-grid">
          ${this.session.players.map((p,u)=>{let y=u===e.dealerIndex,f=!s&&u===i,g=!s&&u===e.trump.winnerIndex,R=e.bets[u],k=!s&&f&&a!==null;return`
              <div class="input-row ${y?"dealer-row":""}" data-player-idx="${u}">
                <div class="input-row-header">
                  <div class="input-row-name">
                    ...
                    <span>${p.name}</span>
                    ${g?`<span style="font-size: 0.62rem; background: #fbbf24; color: black; padding: 1px 5px; border-radius: 4px; font-weight: 800;">${t.trumpMaker.toUpperCase()}</span>`:""}
                    ${f?`<span class="tag-dealer" style="position:static; background: #e11d48;">${t.lastBidder.toUpperCase()}</span>`:""}
                    ${y&&!g&&!f?`<span class="tag-dealer" style="position:static;">${t.dealer.toUpperCase()}</span>`:""}
                  </div>
                  
                  <div class="stepper">
                    <button class="stepper-btn btn-bet-dec" data-player-idx="${u}" ${R===null||R<=0?"disabled":""}>\u2212</button>
                    <span class="stepper-val">${R!==null?R:"\u2014"}</span>
                    <button class="stepper-btn btn-bet-inc" data-player-idx="${u}" ${R>=13?"disabled":""}>+</button>
                  </div>
                </div>

                <div class="chips-row">
                  ${[0,1,2,3,4,5,6,7,8].map($=>`
                    <button class="chip ${R===$?"active":""} ${k&&a===$?"forbidden":""}" 
                            data-player-idx="${u}" data-amount="${$}">
                      ${$===0?"0":$}
                    </button>
                  `).join("")}
                </div>
    ...
    `}renderTricksStage(e,s){let t=this.i18n,i=e.tricks,n=i.reduce((r,l)=>r+(typeof l=="number"&&!isNaN(l)?l:0),0),a=n===13&&i.every(r=>typeof r=="number"&&!isNaN(r)),o=13-n;return`
      <div>
        ...
        <div class="round-inputs-grid">
          ${this.session.players.map((r,l)=>{let d=e.bets[l],c=i[l],m=c!==null&&d!==null&&c===d;return`
              <div class="input-row" data-player-idx="${l}" style="${m?"border-color: rgba(16, 185, 129, 0.4);":""}">
                <div class="input-row-header">
                  <div class="input-row-name">
                  ...
                  <div class="stepper">
                    <button class="stepper-btn btn-trick-dec" data-player-idx="${l}" ${c===null||c<=0?"disabled":""}>\u2212</button>
                    <span class="stepper-val">${c!==null?c:"\u2014"}</span>
                    <button class="stepper-btn btn-trick-inc" data-player-idx="${l}" ${c>=13?"disabled":""}>+</button>
                  </div>
                </div>

                <div class="chips-row">
                  ${[0,1,2,3,4,5,6,7,8].map(p=>`
                    <button class="chip ${c===p?"active":""}" 
                            data-trick-player-idx="${l}" data-amount="${p}">
                      ${p}
                    </button>
                  `).join("")}
                </div>
    ...
    `}renderScorePreview(e){let s=this.i18n,t=e.bets.reduce((n,a)=>n+(typeof a=="number"?a:0),0),i=e.trump?e.trump.isPasRound:!1;return`
      <div class="breakdown-box">
        ...
        <div class="breakdown-items-grid">
          ${this.session.players.map((n,a)=>{let o=F(e.bets[a]||0,e.tricks[a]||0,a===(e.trump?e.trump.winnerIndex:null),i,this.session.rules,t);return`
    ...
    `}bindEvents(e,s){let t=this.container.querySelector("#btn-toggle-simplified");if(t&&t.addEventListener("click",()=>{A(),this.session.setSimplifiedMode(!this.session.simplifiedMode),this.render()}),e==="TRUMP"&&!s){this.container.querySelectorAll(".trump-player-btn").forEach(a=>{a.addEventListener("click",()=>{A();let o=parseInt(a.dataset.playerIdx,10);this.session.activeRound.trump.winnerIndex=o,this.session.activeRound.trump.isPasRound=!1,this.render()})}),this.container.querySelectorAll(".suit-option").forEach(a=>{a.addEventListener("click",()=>{A();let o=a.dataset.suitId;this.session.activeRound.trump.suitId=o,this.session.activeRound.trump.isPasRound=!1,this.render()})}),this.container.querySelectorAll(".trump-target-chip").forEach(a=>{a.addEventListener("click",()=>{A(),this.session.activeRound.trump.bidAmount=parseInt(a.dataset.amount,10),this.session.activeRound.trump.isPasRound=!1,this.render()})});let i=this.container.querySelector("#chk-pas-round");i&&i.addEventListener("change",a=>{A(),this.session.activeRound.trump.isPasRound=a.target.checked,a.target.checked&&(this.session.activeRound.trump.winnerIndex=null),this.render()});let n=this.container.querySelector("#btn-confirm-trump");n&&n.addEventListener("click",()=>{A();let a=this.session.activeRound.trump;this.session.setTrump(a.winnerIndex,a.suitId,a.bidAmount,a.isPasRound),this.render()})}else if(e==="BETS"){this.container.querySelectorAll(".chip[data-player-idx]").forEach(a=>{a.addEventListener("click",()=>{A();let o=parseInt(a.dataset.playerIdx,10),r=parseInt(a.dataset.amount,10);this.session.setBet(o,r),this.render()})}),this.container.querySelectorAll(".btn-bet-dec").forEach(a=>{a.addEventListener("click",()=>{A();let o=parseInt(a.dataset.playerIdx,10),r=this.session.activeRound.bets[o]||0;r>0&&(this.session.setBet(o,r-1),this.render())})}),this.container.querySelectorAll(".btn-bet-inc").forEach(a=>{a.addEventListener("click",()=>{A();let o=parseInt(a.dataset.playerIdx,10),r=this.session.activeRound.bets[o]??-1;r<13&&(this.session.setBet(o,r+1),this.render())})});let i=this.container.querySelector("#btn-back-to-trump");i&&i.addEventListener("click",()=>{A(),this.session.activeRound.stage="TRUMP",this.render()});let n=this.container.querySelector("#btn-proceed-to-tricks");n&&n.addEventListener("click",()=>{A();try{this.session.proceedToTricks(),this.render()}catch(a){alert(a.message)}})}else if(e==="TRICKS"){this.container.querySelectorAll(".chip[data-trick-player-idx]").forEach(o=>{o.addEventListener("click",()=>{A();let r=parseInt(o.dataset.trickPlayerIdx,10),l=parseInt(o.dataset.amount,10);this.session.setTricks(r,l),this.render()})}),this.container.querySelectorAll(".btn-trick-dec").forEach(o=>{o.addEventListener("click",()=>{A();let r=parseInt(o.dataset.playerIdx,10),l=this.session.activeRound.tricks[r]||0;l>0&&(this.session.setTricks(r,l-1),this.render())})}),this.container.querySelectorAll(".btn-trick-inc").forEach(o=>{o.addEventListener("click",()=>{A();let r=parseInt(o.dataset.playerIdx,10),l=this.session.activeRound.tricks[r]??-1;l<13&&(this.session.setTricks(r,l+1),this.render())})});let i=this.container.querySelector("#btn-auto-fill-tricks");i&&i.addEventListener("click",()=>{A(),this.session.autoFillTricksFromBids(),this.render()});let n=this.container.querySelector("#btn-back-to-bets");n&&n.addEventListener("click",()=>{A(),this.session.activeRound.stage="BETS",this.render()});let a=this.container.querySelector("#btn-commit-round");a&&a.addEventListener("click",()=>{A();try{this.session.commitRound(),this.onRoundComplete&&this.onRoundComplete(),this.render()}catch(o){alert(o.message)}})}}};var K=class{constructor(e,s,t,i,n,a,o,r){this.session=e,this.leaderboardContainer=s,this.historyContainer=t,this.i18n=i,this.onUndo=n,this.onReorganizeSeating=a,this.onEditDeal=o,this.onSetBaseline=r,this.isJiggleMode=!1,this.isDragging=!1,document.addEventListener("pointerup",l=>{this.isJiggleMode&&!this.isDragging&&(l.target.closest(".player-card")||this.setJiggleMode(!1))}),this.render()}updateSession(e){this.session=e,!this.isDragging&&!this.isJiggleMode&&this.render()}updateI18n(e){this.i18n=e,!this.isDragging&&!this.isJiggleMode&&this.render()}setJiggleMode(e){if(this.isJiggleMode=e,this.leaderboardContainer){let s=this.leaderboardContainer.querySelector(".leaderboard-grid");s&&s.classList.toggle("is-jiggling",e)}e||this.renderLeaderboard()}render(){this.renderLeaderboard(),this.renderHistoryTable()}renderLeaderboard(){if(!this.leaderboardContainer)return;let e=this.i18n,s=this.session.getRankings(),t=this.session.getCumulativeScores(),i=s.length>0?s[0].score:0,n=this.session.currentDealerIndex,a=`
      <div class="leaderboard-grid ${this.isJiggleMode?"is-jiggling":""}">
        ${this.session.players.map((o,r)=>{let l=t[r],d=s.findIndex(p=>p.index===r),c=l===i&&this.session.completedRounds.length>0,m=r===n;return`
    ...
    `;this.leaderboardContainer.innerHTML=a,this.bindLeaderboardEvents()}bindLeaderboardEvents(){if(!this.leaderboardContainer)return;let e=this.leaderboardContainer.querySelector(".leaderboard-grid");Array.from(this.leaderboardContainer.querySelectorAll(".player-card")).forEach(t=>{let i=null,n=0,a=0,o=0,r=0,l=0,d=0,c=0,m=!1,p=null,u=null,y=[],f=null,g=null,R=(v=25)=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(v)}catch{}},k=()=>Array.from(e.querySelectorAll(".player-card")).map(I=>{let S=I.getBoundingClientRect();return{left:S.left,top:S.top,width:S.width,height:S.height,centerX:S.left+S.width/2,centerY:S.top+S.height/2}}),$=v=>{if(v==null)return;let I=Array.from(e.querySelectorAll(".player-card")),S=[0,1,2,3],[P]=S.splice(p,1);S.splice(v,0,P),I.forEach((U,z)=>{if(z===p)return;let N=S.indexOf(z),G=y[z],H=y[N];if(G&&H){let ie=H.left-G.left,q=H.top-G.top;U.style.transform=`translate3d(${ie}px, ${q}px, 0)`}})},h=()=>{Array.from(e.querySelectorAll(".player-card")).forEach(I=>{I.style.transform="",I.style.zIndex=""})},x=()=>{if(!m)return;let v=o-n,I=r-a;d+=(c-d)*.18,t.style.transform=`translate3d(${v}px, ${I-8}px, 0) scale(1.12) rotate(${d.toFixed(2)}deg)`;let S=y[p],P=S.centerX+v,U=S.centerY+I,z=u,N=1/0;y.forEach((G,H)=>{let J=Math.hypot(P-G.centerX,U-G.centerY)*(H===u?.75:1);J<N&&(N=J,z=H)}),z!==u&&(u=z,R(18),$(u)),g=requestAnimationFrame(x)},b=(v,I)=>{this.isDragging||(this.isDragging=!0,m=!0,p=parseInt(t.dataset.playerIdx,10),u=p,y=k(),this.setJiggleMode(!0),t.classList.remove("card-pressing"),t.classList.add("is-lifted"),t.style.zIndex="500",R([40,60,40]),o=v,r=I,l=v,d=0,c=0,t.style.transform=`translate3d(${v-n}px, ${I-a-8}px, 0) scale(1.12)`,g=requestAnimationFrame(x))},E=v=>{if(f!==null&&v.pointerId!==f)return;let I=v.clientX,S=v.clientY;if(!m){(Math.abs(I-n)>10||Math.abs(S-a)>10)&&(i&&(clearTimeout(i),i=null),t.classList.remove("card-pressing"));return}v.preventDefault(),v.stopPropagation(),o=I,r=S;let P=I-l;l=I,c=Math.max(-7,Math.min(7,P*.4))},T=v=>{if(!(f!==null&&v.pointerId!==f)){if(i&&(clearTimeout(i),i=null),t.classList.remove("card-pressing"),f=null,g&&(cancelAnimationFrame(g),g=null),m){m=!1,this.isDragging=!1;let I=u,S=y[p],P=y[I];if(S&&P&&p!==I){let U=P.left-S.left,z=P.top-S.top;t.classList.add("is-dropping"),t.style.transform=`translate3d(${U}px, ${z}px, 0) scale(1.0) rotate(0deg)`,R(30);let N=[0,1,2,3],[G]=N.splice(p,1);N.splice(I,0,G),this.session.reorderPlayers(N),setTimeout(()=>{t.classList.remove("is-lifted","is-dropping");let H=Array.from(e.querySelectorAll(".player-card"));N.map(q=>H[q]).forEach((q,J)=>{q.dataset.playerIdx=J,q.style.transform="",q.style.zIndex="",e.appendChild(q)}),h()},260)}else t.classList.remove("is-lifted"),h()}window.removeEventListener("pointermove",E),window.removeEventListener("pointerup",T),window.removeEventListener("pointercancel",T)}},D=v=>{this.isDragging||(f=v.pointerId,n=v.clientX,a=v.clientY,o=v.clientX,r=v.clientY,l=v.clientX,t.classList.add("card-pressing"),window.addEventListener("pointermove",E,{passive:!1}),window.addEventListener("pointerup",T),window.addEventListener("pointercancel",T),this.isJiggleMode?b(n,a):i=setTimeout(()=>{b(n,a)},260))};t.addEventListener("pointerdown",D),t.addEventListener("contextmenu",v=>v.preventDefault())})}renderHistoryTable(){if(!this.historyContainer)return;let e=this.i18n,s=this.session.completedRounds,t=this.session.initialScores&&this.session.initialScores.some(r=>r!==0);if(s.length===0){this.historyContainer.innerHTML=`
            ...
            <tbody>
              ${s.map((r,l)=>{let d=this.session.players[r.dealerIndex];return`
                  <tr>
                    ...
                    ${this.session.players.map((c,m)=>{let p=r.results.find(g=>g.playerIndex===m);if(!p)return"<td>\u2014</td>";let u=p.score>=0?`+${p.score}`:p.score,y=p.made,f=r.cumulativeScores?r.cumulativeScores[m]:"\u2014";return`
                        <td>
                          <div style="font-size: 0.72rem; color: var(--text-muted); direction: ltr; unicode-bidi: isolate;">
                            B:${p.bid} / T:${p.tricks}
                          </div>
                          <div class="score-delta signed-score" dir="ltr" style="font-weight: 800; direction: ltr; unicode-bidi: isolate; color: ${y?"var(--success)":"var(--danger)"};">
                            ${u}
                          </div>
              ...
              ${t?`
                <tr style="background: rgba(255,255,255,0.03); border-top: 1px dashed var(--border-color);">
                  ...
                  ${this.session.players.map((r,l)=>{let d=this.session.initialScores&&this.session.initialScores[l]||0,c=d>=0?`+${d}`:`${d}`;return`
                      <td>
      ...
      <div class="card">
        ...
        <div style="overflow-x: auto;">
          <svg viewBox="0 0 ${l} ${d}" style="width: 100%; max-width: 600px; height: auto; display: block; margin: 0 auto;">
            <!-- Zero axis -->
            <line x1="${c}" y1="${k}" x2="${l-m}" y2="${k}" stroke="rgba(255,255,255,0.2)" stroke-width="1" stroke-dasharray="3 3" />
            <text x="${c-6}" y="${k+3}" fill="var(--text-muted)" font-size="9" text-anchor="end">0</text>
            <text x="${c-6}" y="${p+6}" fill="var(--text-muted)" font-size="9" text-anchor="end">${o}</text>
            <text x="${c-6}" y="${d-u}" fill="var(--text-muted)" font-size="9" text-anchor="end">${a}</text>

            ${t.map((h,x)=>`
              <text x="${g(x)}" y="${d-10}" fill="var(--text-muted)" font-size="9" text-anchor="middle">${h}</text>
            `).join("")}

            ${n.map(h=>{let x=h.points.map((b,E)=>`${g(E)},${R(b)}`).join(" ");return`
                <polyline fill="none" stroke="${h.player.color}" stroke-width="2" points="${x}" />
                ${h.points.map((b,E)=>`
                  <circle cx="${g(E)}" cy="${R(b)}" r="3.5" fill="${h.player.color}" stroke="#111827" stroke-width="1.5">
                    <title>${h.player.name}: ${b}</title>
                  </circle>
                `).join("")}
              `}).join("")}
          </svg>
    ...
    `;this.container.innerHTML=$}};function ue(w){let e=w.completedRounds,s=e.length,i=w.players.map((l,d)=>{let c=0,m=0,p=0,u=0,y=0,f=0,g=0,R=0,k=0,$=-1/0,h=1/0,x=[0],b=0;e.forEach(S=>{let P=S.results.find(U=>U.playerIndex===d);P&&(c+=P.score,b+=P.score,x.push(b),p++,u+=P.bid||0,y+=P.tricks||0,P.made&&m++,P.bid===0&&(f++,P.made&&g++),S.trump.winnerIndex===d&&(R++,P.made&&k++),P.score>$&&($=P.score),P.score<h&&(h=P.score))});let E=p>0?m/p*100:0,T=s>0?y/s:0,D=p>0?u/p:0,v=f>0?g/f*100:0,I=R>0?k/R*100:0;return{player:l,pIdx:d,totalScore:c,madeBidsCount:m,totalBidsCount:p,hitRate:Math.round(E*10)/10,totalTricksWon:y,avgTricksPerRound:Math.round(T*10)/10,avgBidPerRound:Math.round(D*10)/10,zeroAttempts:f,zeroSuccess:g,zeroRate:Math.round(v*10)/10,passAttempts:f,passSuccess:g,passRate:Math.round(v*10)/10,trumpMakerCount:R,trumpMakerSuccess:k,trumpRate:Math.round(I*10)/10,highestSingleRound:$===-1/0?0:$,lowestSingleRound:h===1/0?0:h,roundScoresHistory:x}}),n=0,a=0,o=0;e.forEach(l=>{l.trump.isPasRound?o++:l.roundTotalBets>13?n++:l.roundTotalBets<13&&a++});let r=[...i].sort((l,d)=>d.totalScore-l.totalScore);return{numRounds:s,rankings:r,playerStats:i,overRoundsCount:n,underRoundsCount:a,pasRoundsCount:o,mostAccuratePlayer:[...i].sort((l,d)=>d.hitRate-l.hitRate)[0],mostAggressiveBidder:[...i].sort((l,d)=>d.avgBidPerRound-l.avgBidPerRound)[0],masterOfZero:[...i].sort((l,d)=>d.zeroSuccess-l.zeroSuccess)[0],masterOfPass:[...i].sort((l,d)=>d.zeroSuccess-l.zeroSuccess)[0]}}var te=class{constructor(e){this.app=e}showMenuModal(){let e=this.app.i18n,s=e.lang==="he",t=this.app.session.simplifiedMode,i=M.getRecentGames(),n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
      <div class="modal-box">
    ...
    `,document.body.appendChild(n);let a=()=>n.remove();n.querySelectorAll(".modal-close").forEach(o=>o.addEventListener("click",a)),n.querySelector("#menu-opt-toggle-lang").addEventListener("click",()=>{a(),this.app.setLanguage(s?"en":"he")}),n.querySelector("#menu-opt-home-lobby").addEventListener("click",()=>{a(),this.app.showLandingView()}),n.querySelector("#menu-opt-baseline").addEventListener("click",()=>{a(),this.showBaselineModal()}),n.querySelector("#menu-opt-profiles").addEventListener("click",()=>{a(),this.showProfilesModal()}),n.querySelector("#menu-opt-saved-games").addEventListener("click",()=>{a(),this.showSavedGamesModal()}),n.querySelector("#menu-opt-edit-players").addEventListener("click",()=>{a(),this.showEditSettingsModal()}),n.querySelector("#menu-opt-toggle-mode").addEventListener("click",()=>{this.app.session.setSimplifiedMode(!this.app.session.simplifiedMode),a()}),n.querySelector("#menu-opt-new-game").addEventListener("click",()=>{a(),this.showNewGameModal()}),n.querySelector("#menu-opt-share").addEventListener("click",()=>{a(),this.showShareModal()}),n.querySelector("#menu-opt-stats").addEventListener("click",()=>{a(),this.showStatsModal()}),n.querySelector("#menu-opt-export").addEventListener("click",()=>{a(),this.showExportModal()})}showReorganizeSeatingModal(e=null){let s=this.app.i18n,t=this.app.session,i=e!==null?e:null,n=document.createElement("div");n.className="modal-overlay";let a=()=>{let o=d=>t.currentDealerIndex===d;n.innerHTML=`
        <div class="modal-box" style="max-width: 460px;">
          ...
          <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg); padding: 1rem 0.75rem; margin: 0.75rem 0; position: relative;">
            ...
            <div class="leaderboard-grid seating-modal-grid" style="margin-bottom: 0;">
              ${t.players.map((d,c)=>{let m=i===c,p=o(c);return`
                  <div class="player-card seat-swap-card ${m?"seat-selected":""} ${p?"is-dealer":""}" 
                       data-seat-idx="${c}" 
                       style="cursor: pointer; transition: all 0.18s ease; ${m?"border: 2px solid #fbbf24; background: rgba(251, 191, 36, 0.15); transform: scale(1.04);":""}">
                    ${p?`<span class="tag-dealer">${s.dealer.toUpperCase()}</span>`:""}
                    ...
                    <div style="font-size: 0.72rem; color: ${m?"#fde68a":"var(--accent-primary)"}; font-weight: 700; margin-top: 4px;">
                      ${m?"\u2713 Selected":"Tap to Swap"}
                    </div>
                  </div>
                `}).join("")}
            </div>
      ...
      `,n.querySelectorAll(".modal-close").forEach(d=>d.addEventListener("click",()=>n.remove())),n.querySelectorAll(".seat-swap-card").forEach(d=>{d.addEventListener("click",()=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}let c=parseInt(d.dataset.seatIdx,10);i===null?(i=c,a()):i===c?(i=null,a()):(t.swapPlayers(i,c),i=null,a())})});let r=n.querySelector("#btn-rot-cw");r&&r.addEventListener("click",()=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}t.rotateSeatingClockwise(),a()});let l=n.querySelector("#btn-rot-ccw");l&&l.addEventListener("click",()=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}t.rotateSeatingCounterClockwise(),a()})};a(),document.body.appendChild(n)}showSavedGamesModal(){let e=this.app.i18n,s=e.lang==="he",t=M.getRecentGames(),i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
    ...
    `,document.body.appendChild(n);let a=()=>n.remove();if(n.querySelectorAll(".modal-close").forEach(o=>o.addEventListener("click",a)),e!==null){let o=n.querySelector(`.edit-player-name-input[data-p-idx="${e}"]`);o&&setTimeout(()=>{o.focus(),o.select()},100)}n.querySelector("#btn-save-settings").addEventListener("click",()=>{let o=n.querySelectorAll(".edit-player-name-input"),r=parseInt(n.querySelector("#edit-dealer-select").value,10),l=n.querySelector("#edit-mode-select").value==="SIMPLIFIED",d=n.querySelector("#edit-rule-select").value,c=n.querySelector("#chk-edit-hook").checked;i.players.forEach((m,p)=>{let u=o[p].value.trim();u&&(m.name=u)}),i.currentDealerIndex=r,i.activeRound&&(i.activeRound.dealerIndex=r,i.activeRound.leadBidderIndex=(r+1)%4),i.rules={...j[d],enforceHookRule:c},i.setSimplifiedMode(l),i.notify(),a()})}showShareModal(){let e=this.app.i18n,s=this.app.syncManager;this.app.session&&(this.app.archiveCurrentGame(),s&&s.broadcastLocalState());let t=s?s.getShareUrl():window.location.href,i=s?s.roomId:"Local",n=`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(t)}`,a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
      <div class="modal-box">
        <div class="modal-head">
          <div>
    ...
    `,document.body.appendChild(a);let o=()=>a.remove();a.querySelectorAll(".modal-close").forEach(l=>l.addEventListener("click",o)),a.querySelector("#btn-copy-url").addEventListener("click",()=>{navigator.clipboard.writeText(t);let l=a.querySelector("#btn-copy-url");l.textContent=e.copied,setTimeout(()=>l.textContent=e.copy,2e3)});let r=a.querySelector("#btn-native-share");r&&r.addEventListener("click",()=>{navigator.share({title:e.appTitle,text:`${e.shareTitle} (${i})`,url:t}).catch(()=>{})})}showNewGameModal(){let e=this.app.i18n,s=e.lang==="he",t=this.app.session,i=M.getRecentGames(),n=C.getProfiles(),a=C.getLastLineup(),o=[null,null,null,null],r=0,l=null,d=document.createElement("div");d.className="modal-overlay";let c=()=>{n=C.getProfiles();let p=o.filter(u=>u&&u.name).length;d.innerHTML=`
        <div class="modal-box modal-new-game">
          ...
          <div class="table-seating-container">
            ...
            <div class="leaderboard-grid seating-modal-grid" style="margin-bottom: 0;">
              ${[0,1,2,3].map(u=>{let y=o[u],f=!!(y&&y.name),g=u===0,R=l===u,k=r===u,$="player-card seat-card-interactive";return f?$+=" is-filled":$+=" is-placeholder",R?$+=" is-swap-selected":k&&($+=" is-active-target"),`
                  <div class="${$}" data-player-idx="${u}" data-seat-idx="${u}" title="${f?s?"\u05DC\u05D7\u05E5 \u05DC\u05D4\u05D7\u05DC\u05E4\u05EA \u05DE\u05E7\u05D5\u05DD":"Tap to swap seat":s?"\u05DC\u05D7\u05E5 \u05DC\u05D1\u05D7\u05D9\u05E8\u05EA \u05E9\u05D7\u05E7\u05DF":"Tap to assign player"}">
                    <div class="seat-top-row">
                      <span>${e.seatNumber} #${u+1}</span>
                      ${g?`<span class="tag-dealer" style="position: static;">${e.dealer.toUpperCase()}</span>`:""}
                      ${f?`<button type="button" class="btn-clear-seat" data-seat-idx="${u}" title="${e.clearSeat}">\u2715</button>`:""}
                    </div>

                    <div style="margin: 2px 0;">
                      ${f?`
                        <div class="seat-avatar-bubble" style="border-color: ${y.color}; background: ${y.color}24;">
                          ${y.avatar}
                        </div>
                      `:`
                    ...
                    <div class="seat-player-name">
                      ${f?y.name:e.emptySeatPlaceholder}
                    </div>

                    <div class="seat-action-hint" style="color: ${R?"#fde68a":f?"var(--accent-primary)":"var(--text-muted)"};">
                      ${R?"\u2713 "+(s?"\u05E0\u05D1\u05D7\u05E8 \u05DC\u05D4\u05D7\u05DC\u05E4\u05D4":"Selected"):f?s?"\u05DC\u05D7\u05E5 \u05DC\u05D4\u05D7\u05DC\u05E4\u05D4":"Tap to swap":k?s?"\u05D9\u05E2\u05D3 \u05DC\u05D1\u05D7\u05D9\u05E8\u05D4":"Target seat":s?"\u05DC\u05D7\u05E5 \u05DC\u05D1\u05D7\u05D9\u05E8\u05D4":"Tap to pick"}
                    </div>
                  </div>
                `}).join("")}
            </div>
          ...
          <div style="background: rgba(0,0,0,0.25); border: 1px solid var(--border-subtle); border-radius: var(--radius-md); padding: 0.65rem 0.75rem; margin-bottom: 0.75rem;">
            ...
            <div class="roster-chips-wrap" id="roster-chips-container">
              ${n.map(u=>{let y=o.findIndex(g=>g&&g.name&&g.name.trim().toLowerCase()===u.name.trim().toLowerCase()),f=y>=0;return`
                  <button type="button" class="profile-chip ${f?"is-assigned":""}" data-prof-id="${u.id}">
                    <span class="chip-avatar" style="border-color: ${u.color}; background: ${u.color}22;">${u.avatar}</span>
                    <span class="chip-name">${u.name}</span>
                    ${f?`<span class="chip-seat-badge">S${y+1}</span>`:""}
                  </button>
                `}).join("")}
            </div>
          </div>
          ...
          <div style="display: flex; gap: 0.45rem;">
            ...
            <button type="button" class="btn-block btn-hero-start" id="btn-start-new-game" style="flex: 2; font-size: 0.95rem; ${p<4?"opacity: 0.6;":""}">
              ${e.startGame} (${p}/4) \u2192
            </button>
          </div>
      ...
      `,m()},m=()=>{let p=()=>d.remove();d.querySelectorAll(".modal-close").forEach(h=>h.addEventListener("click",p)),d.querySelectorAll(".seat-card-interactive").forEach(h=>{h.addEventListener("click",x=>{if(x.target.closest(".btn-clear-seat"))return;let b=parseInt(h.dataset.seatIdx,10),E=!!(o[b]&&o[b].name);if(l===null)E&&(l=b),r=b,c();else if(l===b)l=null,c();else{let T=o[l];if(o[l]=o[b],o[b]=T,l=null,r=b,typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}c()}})}),d.querySelectorAll(".btn-clear-seat").forEach(h=>{h.addEventListener("click",x=>{x.stopPropagation();let b=parseInt(h.dataset.seatIdx,10);o[b]=null,r=b,l=null,c()})});let u=d.querySelector("#btn-new-game-rot-cw");u&&u.addEventListener("click",()=>{if(o=[o[3],o[0],o[1],o[2]],l=null,typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}c()});let y=d.querySelector("#btn-new-game-rot-ccw");y&&y.addEventListener("click",()=>{if(o=[o[1],o[2],o[3],o[0]],l=null,typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}c()}),d.querySelectorAll(".profile-chip").forEach(h=>{h.addEventListener("click",()=>{let x=h.dataset.profId,b=C.getProfile(x);if(!b)return;let E=o.findIndex(v=>v&&v.name&&v.name.trim().toLowerCase()===b.name.trim().toLowerCase());if(E>=0){l=E,r=E,c();return}let T=r;if(o[T]&&o[T].name){let v=o.findIndex(I=>!I||!I.name);v>=0&&(T=v)}o[T]={name:b.name,color:b.color,avatar:b.avatar,baselineScore:0};let D=o.findIndex((v,I)=>!v||!v.name);if(D>=0?r=D:r=(T+1)%4,l=null,typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(12)}catch{}c()})});let f=d.querySelector("#btn-clear-all-seats");f&&f.addEventListener("click",()=>{o=[null,null,null,null],r=0,l=null,c()});let g=d.querySelector("#btn-use-last-lineup");g&&g.addEventListener("click",()=>{let h=C.getLastLineup();h&&Array.isArray(h)&&h.length===4&&(o=h.map((x,b)=>({name:x.name,avatar:x.avatar||L[b%L.length],color:x.color||B[b%B.length],baselineScore:0})),l=null,c())});let R=d.querySelector("#btn-add-profile-from-new");R&&R.addEventListener("click",()=>{this.showCreateEditProfileModal(null,h=>{if(h){let x=r;if(o[x]&&o[x].name){let E=o.findIndex(T=>!T||!T.name);E>=0&&(x=E)}o[x]={name:h.name,color:h.color,avatar:h.avatar,baselineScore:0};let b=o.findIndex((E,T)=>!E||!E.name);b>=0?r=b:r=(x+1)%4,c()}})});let k=d.querySelector("#btn-manage-profiles-from-new");k&&k.addEventListener("click",()=>{this.showProfilesModal(()=>{c()})});let $=d.querySelector("#btn-open-recent-from-new");$&&$.addEventListener("click",()=>{p(),this.showSavedGamesModal()}),d.querySelector("#btn-start-new-game").addEventListener("click",()=>{if(o.filter(S=>S&&S.name).length<4){let S=o.findIndex(P=>!P||!P.name);S>=0&&(r=S,c()),alert(e.mustChoose4Players);return}let x=d.querySelector("#chk-new-game-simplified").checked,b=d.querySelector("#new-game-rule-select").value,E=d.querySelector("#new-game-target-select").value,T=o.map((S,P)=>({id:`p${P}`,name:S.name.trim(),color:S.color||B[P%B.length],avatar:S.avatar||L[P%L.length]})),D=o.map(S=>parseInt(S.baselineScore,10)||0);T.forEach(S=>{C.saveProfile({name:S.name,color:S.color,avatar:S.avatar})}),C.saveLastLineup(T);let v=null,I=null;E==="13_ROUNDS"?v=13:E==="16_ROUNDS"?v=16:E==="TARGET_500"?I=500:E==="TARGET_1000"&&(I=1e3),this.app.startNewGame({players:T,rules:{...j[b]},maxRounds:v,targetPoints:I,simplifiedMode:x,initialScores:D}),p()})};c(),document.body.appendChild(d)}showProfilesModal(e=null){let s=this.app.i18n,t=s.lang==="he",i=document.createElement("div");i.className="modal-overlay";let n=()=>{let o=C.getProfiles();i.innerHTML=`
        <div class="modal-box" style="max-width: 500px;">
          ...
          <div class="profiles-list-container" style="display: flex; flex-direction: column; gap: 0.55rem; max-height: 52vh; overflow-y: auto; padding-right: 2px;">
            ${o.map(r=>{let l=r.gamesPlayed>0?Math.round(r.wins/r.gamesPlayed*100):0,d=r.zeroBids>0?Math.round(r.zeroHits/r.zeroBids*100):0,c=r.gamesPlayed>0?Math.round(r.totalScore/r.gamesPlayed):0;return`
      ...
      `,a()},a=()=>{let o=()=>{i.remove(),e&&e()};i.querySelectorAll(".modal-close").forEach(l=>l.addEventListener("click",o));let r=i.querySelector("#btn-add-profile-main");r&&r.addEventListener("click",()=>{this.showCreateEditProfileModal(null,()=>n())}),i.querySelectorAll(".btn-edit-prof").forEach(l=>{l.addEventListener("click",()=>{let d=C.getProfile(l.dataset.profId);d&&this.showCreateEditProfileModal(d,()=>n())})}),i.querySelectorAll(".btn-delete-prof").forEach(l=>{l.addEventListener("click",()=>{let d=C.getProfile(l.dataset.profId);d&&confirm(s.deleteProfileConfirm.replace("{name}",d.name))&&(C.deleteProfile(d.id),n())})})};n(),document.body.appendChild(i)}showCreateEditProfileModal(e=null,s=null){let t=this.app.i18n,i=t.lang==="he",n=!!e,a=e?e.avatar:L[Math.floor(Math.random()*L.length)],o=e?e.color:B[Math.floor(Math.random()*B.length)],r=document.createElement("div");r.className="modal-overlay",r.style.zIndex="300";let l=()=>{r.innerHTML=`
        <div class="modal-box" style="max-width: 420px;">
          ...
          <div style="margin-bottom: 1rem;">
            ...
            <div class="color-picker-swatches">
              ${B.map(c=>`
                <button type="button" class="color-swatch-btn ${c===o?"is-selected":""}" data-color="${c}" style="background: ${c};"></button>
              `).join("")}
            </div>
          </div>
      ...
      `,d()},d=()=>{let c=()=>r.remove();r.querySelectorAll(".modal-close").forEach(m=>m.addEventListener("click",c)),r.querySelectorAll(".emoji-option-btn").forEach(m=>{m.addEventListener("click",()=>{a=m.dataset.avatar,l()})}),r.querySelectorAll(".color-swatch-btn").forEach(m=>{m.addEventListener("click",()=>{o=m.dataset.color,l()})}),r.querySelector("#btn-save-prof-confirm").addEventListener("click",()=>{let m=r.querySelector("#prof-modal-name").value.trim();if(!m){r.querySelector("#prof-modal-name").focus();return}let p=C.saveProfile({id:e?.id,name:m,avatar:a,color:o});c(),s&&s(p)})};l(),document.body.appendChild(r)}showAvatarPickerModal(e,s="\u{1F98A}",t="#6366f1"){let i=this.app.i18n,n=s,a=t,o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="350",o.innerHTML=`
...
`});let a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
    ...
    `,document.body.appendChild(n);let a=()=>n.remove();n.querySelectorAll(".modal-close").forEach(o=>o.addEventListener("click",a)),n.querySelector("#btn-save-baseline").addEventListener("click",()=>{let o=n.querySelectorAll(".baseline-score-input"),r=[];o.forEach(l=>{r.push(parseInt(l.value,10)||0)}),t.setInitialScores(r),a()})}showEditDealModal(e){let s=this.app.i18n,t=s.lang==="he",i=this.app.session;if(e<0||e>=i.completedRounds.length)return;let n=i.completedRounds[e],a=[...n.bets],o=[...n.tricks],r=n.dealerIndex,l=document.createElement("div");l.className="modal-overlay";let d=()=>{let u=o.reduce((k,$)=>k+(parseInt($,10)||0),0),y=a.reduce((k,$)=>k+(parseInt($,10)||0),0),f=n.trump&&n.trump.isPasRound,g=k=>!n.simplified&&n.trump&&n.trump.winnerIndex===k,R=[];for(let k=0;k<4;k++){let $=parseInt(a[k],10)||0,h=parseInt(o[k],10)||0,x=F($,h,g(k),f,i.rules,y);R.push(x)}return{sumTricks:u,sumBets:y,playerScores:R}},c=()=>{let{sumTricks:u,sumBets:y,playerScores:f}=d(),g=l.querySelector("#edit-tricks-sum-badge"),R=l.querySelector("#edit-bets-sum-badge"),k=l.querySelector("#edit-hook-warning"),$=l.querySelector("#btn-save-edit-deal");if(g&&(g.textContent=`${t?"\u05E1\u05DA \u05DC\u05E7\u05D9\u05D7\u05D5\u05EA":"Tricks"}: ${u}/13`,u===13?(g.style.background="rgba(16, 185, 129, 0.2)",g.style.color="#a7f3d0",g.style.borderColor="rgba(16, 185, 129, 0.4)"):(g.style.background="rgba(239, 68, 68, 0.2)",g.style.color="#fca5a5",g.style.borderColor="rgba(239, 68, 68, 0.4)")),R&&(R.textContent=`${t?"\u05E1\u05DA \u05D4\u05DB\u05E8\u05D6\u05D5\u05EA":"Bids"}: ${y}`),k&&(y===13&&i.rules.enforceHookRule?k.style.display="block":k.style.display="none"),f.forEach((h,x)=>{let b=l.querySelector(`.edit-p-score-${x}`);if(b){let E=h.score>=0?`+${h.score}`:`${h.score}`;b.textContent=E,b.style.color=h.made?"var(--success)":"var(--danger)"}}),$){let h=u===13;$.disabled=!h,$.style.opacity=h?"1":"0.4",$.style.cursor=h?"pointer":"not-allowed"}};l.innerHTML=`
      <div class="modal-box modal-box-wide">
        ...
        <div style="margin: 0.75rem 0 0.85rem; display: flex; align-items: center; justify-content: space-between; gap: 8px; background: rgba(0,0,0,0.2); padding: 8px 12px; border-radius: var(--radius-md); border: 1px solid var(--border-subtle);">
          ...
          <select id="edit-deal-dealer" class="select-field" style="width: auto; margin-bottom: 0; padding: 4px 8px; font-size: 0.82rem;">
            ${i.players.map((u,y)=>`
              <option value="${y}" ${y===r?"selected":""}>${u.name}</option>
            `).join("")}
          </select>
        </div>
          ...
          ${i.players.map((u,y)=>`
            <div class="edit-deal-player-row" style="display: flex; align-items: center; justify-content: space-between; padding: 8px 10px; background: rgba(0,0,0,0.25); border-radius: var(--radius-md); border: 1px solid var(--border-subtle);">
              <div style="display: flex; align-items: center; gap: 6px; min-width: 85px; flex: 1;">
                ...
                <span style="font-size: 0.85rem; font-weight: 700; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${u.name}</span>
              </div>

              <div style="display: flex; align-items: center; gap: 8px;">
                <div style="display: flex; align-items: center; gap: 4px;">
                  <span style="font-size: 0.7rem; color: var(--text-muted); font-weight: 700;">B:</span>
                  <input type="number" min="0" max="13" class="input-field edit-deal-bid" data-p-idx="${y}" value="${a[y]}" style="width: 48px; margin-bottom: 0; padding: 4px; text-align: center; font-size: 0.85rem; font-weight: 700;" />
                </div>

                <div style="display: flex; align-items: center; gap: 4px;">
                  <span style="font-size: 0.7rem; color: var(--text-muted); font-weight: 700;">T:</span>
                  <input type="number" min="0" max="13" class="input-field edit-deal-trick" data-p-idx="${y}" value="${o[y]}" style="width: 48px; margin-bottom: 0; padding: 4px; text-align: center; font-size: 0.85rem; font-weight: 700;" />
                </div>

                <div class="edit-p-score-${y} signed-score" dir="ltr" style="min-width: 45px; text-align: center; font-size: 0.85rem; font-weight: 800; direction: ltr; unicode-bidi: isolate;">
                  \u2014
                </div>
              </div>
            </div>
