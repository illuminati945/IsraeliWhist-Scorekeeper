var z={STANDARD:{id:"STANDARD",nameEn:"Standard Israeli Whist (Quadratic)",nameHe:"Standard Israeli Whist",descriptionEn:"Exact Made: +10 + Bid\xB2 | Miss: -10 \xD7 diff | Zero: +50 down / +30 up, -50 + 10/trick | Hook Rule: On",descriptionHe:"\u05DE\u05D3\u05D5\u05D9\u05E7: 10 + \u05D4\u05DB\u05E8\u05D6\u05D4\xB2 | \u05D4\u05D7\u05D8\u05D0\u05D4: 10- \u05DC\u05DB\u05DC \u05D4\u05E4\u05E8\u05E9 | \u05D0\u05E4\u05E1: 50+ \u05D1\u05D7\u05E1\u05E8 / 30+ \u05D1\u05D9\u05EA\u05E8, 50- \u05D5-10+ \u05DC\u05DB\u05DC \u05DC\u05E7\u05D9\u05D7\u05D4 \u05E0\u05D5\u05E1\u05E4\u05EA | \u05D7\u05D5\u05E7 \u05D4\u05D4\u05D5\u05E7",bidMadeFormula:"QUADRATIC",missPenaltyRate:10,useProgressivePenalty:!1,passMadeScoreDown:50,passMadeScoreUp:30,passMadeScore:50,passMissPenalty:50,passMissBonusPerTrick:10,pasRoundTrickPenalty:10,pasRoundZeroBonus:50,enforceHookRule:!0,trumpMakerMissDoublePenalty:!1},PROGRESSIVE:{id:"PROGRESSIVE",nameEn:"Progressive Penalty (Tournament)",nameHe:"Progressive Penalty (Tournament)",descriptionEn:"Exact Made: +10 + Bid\xB2 | Miss: -5/-10/-15/-20 per trick by bid | Zero: +50 down / +30 up, -50 + 10/trick",descriptionHe:"\u05DE\u05D3\u05D5\u05D9\u05E7: 10 + \u05D4\u05DB\u05E8\u05D6\u05D4\xB2 | \u05D4\u05D7\u05D8\u05D0\u05D4 \u05E4\u05E8\u05D5\u05D2\u05E8\u05E1\u05D9\u05D1\u05D9\u05EA \u05DC\u05E4\u05D9 \u05D4\u05DB\u05E8\u05D6\u05D4 | \u05D0\u05E4\u05E1: 50+ \u05D1\u05D7\u05E1\u05E8 / 30+ \u05D1\u05D9\u05EA\u05E8, 50- \u05D5-10+ \u05DC\u05DB\u05DC \u05DC\u05E7\u05D9\u05D7\u05D4 \u05E0\u05D5\u05E1\u05E4\u05EA",bidMadeFormula:"QUADRATIC",missPenaltyRate:10,useProgressivePenalty:!0,progressiveRates:{1:5,2:5,3:5,4:5,5:10,6:15,7:20},passMadeScoreDown:50,passMadeScoreUp:30,passMadeScore:50,passMissPenalty:50,passMissBonusPerTrick:10,pasRoundTrickPenalty:10,pasRoundZeroBonus:50,enforceHookRule:!0,trumpMakerMissDoublePenalty:!1},CLASSIC_LINEAR:{id:"CLASSIC_LINEAR",nameEn:"Classic Linear (10 + 10xBid)",nameHe:"Classic Linear (10 + 10xBid)",descriptionEn:"Exact Made: +10 + (Bid \xD7 10) | Miss: -10 \xD7 diff | Zero: +50 down / +30 up, -50 + 10/trick",descriptionHe:"\u05DE\u05D3\u05D5\u05D9\u05E7: 10 + (10 \xD7 \u05D4\u05DB\u05E8\u05D6\u05D4) | \u05D4\u05D7\u05D8\u05D0\u05D4: 10- \u05DC\u05DB\u05DC \u05D4\u05E4\u05E8\u05E9 | \u05D0\u05E4\u05E1: 50+ \u05D1\u05D7\u05E1\u05E8 / 30+ \u05D1\u05D9\u05EA\u05E8, 50- \u05D5-10+ \u05DC\u05DB\u05DC \u05DC\u05E7\u05D9\u05D7\u05D4 \u05E0\u05D5\u05E1\u05E4\u05EA",bidMadeFormula:"LINEAR_10",missPenaltyRate:10,useProgressivePenalty:!1,passMadeScoreDown:50,passMadeScoreUp:30,passMissPenalty:50,passMissBonusPerTrick:10,pasRoundTrickPenalty:10,pasRoundZeroBonus:50,enforceHookRule:!0,trumpMakerMissDoublePenalty:!1}},ie=[{id:"NT",symbol:"NT",nameEn:"No Trump",color:"#6366f1",rank:5},{id:"SPADES",symbol:"\u2660",nameEn:"Spades",color:"#94a3b8",rank:4},{id:"HEARTS",symbol:"\u2665",nameEn:"Hearts",color:"#f43f5e",rank:3},{id:"DIAMONDS",symbol:"\u2666",nameEn:"Diamonds",color:"#fbbf24",rank:2},{id:"CLUBS",symbol:"\u2663",nameEn:"Clubs",color:"#34d399",rank:1}];function j(v,e,s=!1,t=!1,i=z.STANDARD,n=13){if(t)if(e===0){let o=i.pasRoundZeroBonus||50;return{score:o,made:!0,delta:0,explanation:`0 tricks taken: +${o} bonus`}}else{let o=-(e*(i.pasRoundTrickPenalty||10));return{score:o,made:!1,delta:e,explanation:`${e} tricks taken \xD7 -${i.pasRoundTrickPenalty||10} = ${o}`}}if(v===e)if(v===0){let o=n>13,d=i.passMadeScoreDown??(i.passMadeScore||50),c=i.passMadeScoreUp??(i.passMadeScoreOver||30),h=o?c:d;return{score:h,made:!0,delta:0,explanation:`Bid 0 made (${o?"Up / \u05D9\u05EA\u05E8":"Down / \u05D7\u05E1\u05E8"}): +${h} pts`}}else{let o=0;return i.bidMadeFormula==="QUADRATIC"?o=10+v*v:i.bidMadeFormula==="LINEAR_10"?o=10+v*10:o=10+v*v,{score:o,made:!0,delta:0,explanation:`Bid ${v} made: 10 + (${v}\xB2) = +${o} pts`}}let r=Math.abs(e-v);if(v===0){let o=i.passMissPenalty??50,d=i.passMissBonusPerTrick??10,c=-o+(e-1)*d,h=e===1?`Bid 0 missed (1 trick): -${o} pts`:`Bid 0 missed (${e} tricks): -${o} + ${(e-1)*d} = ${c>=0?"+":""}${c} pts`;return{score:c,made:!1,delta:r,explanation:h}}let l=i.missPenaltyRate||10;if(i.useProgressivePenalty&&i.progressiveRates){let o=Math.min(Math.max(v,1),7);l=i.progressiveRates[o]||10}let a=-(r*l);return s&&i.trumpMakerMissDoublePenalty&&(a*=2),{score:a,made:!1,delta:r,explanation:`Bid ${v}, took ${e} (${r} diff \xD7 -${l}): ${a} pts`}}function F(v){let e=v.reduce((s,t)=>s+(typeof t=="number"&&!isNaN(t)?t:0),0);return v.length===4&&v.every(s=>typeof s=="number"&&!isNaN(s))?e===13?{isValid:!1,sum:e,status:"HOOK_VIOLATION"}:{isValid:!0,sum:e,status:e>13?"OVER":"UNDER"}:{isValid:!0,sum:e,status:e>13?"OVER":"UNDER"}}function ne(v){return v.length!==4?!1:v.reduce((s,t)=>s+(typeof t=="number"&&!isNaN(t)?t:0),0)===13}var ee="israeli_whist_current_game_v2",G=class v{constructor(e={}){this.id=e.id||"game_"+Date.now(),this.createdAt=e.createdAt||new Date().toISOString(),this.rules=e.rules||{...z.STANDARD},this.targetPoints=e.targetPoints||null,this.maxRounds=e.maxRounds||null,this.simplifiedMode=e.simplifiedMode!==void 0?e.simplifiedMode:!0,this.players=e.players||[{id:"p0",name:"Player 1",color:"#6366f1",initial:"1"},{id:"p1",name:"Player 2",color:"#10b981",initial:"2"},{id:"p2",name:"Player 3",color:"#f59e0b",initial:"3"},{id:"p3",name:"Player 4",color:"#ec4899",initial:"4"}],this.currentDealerIndex=e.currentDealerIndex??0,this.roundNumber=e.roundNumber||1,this.completedRounds=e.completedRounds||[],this.initialScores=Array.isArray(e.initialScores)?e.initialScores.map(s=>parseInt(s,10)||0):[0,0,0,0],this.activeRound=e.activeRound||this.initDraftRound(),this.status=e.status||"IN_PROGRESS",this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(s=>s!==e)}}notify(){this.saveToStorage();for(let e of this.listeners)e(this)}initDraftRound(){let e=this.currentDealerIndex,s=(e+1)%4;return{roundNumber:this.roundNumber,dealerIndex:e,leadBidderIndex:s,stage:this.simplifiedMode?"BETS":"TRUMP",trump:{winnerIndex:null,suitId:"NT",bidAmount:0,isPasRound:!1},bets:[null,null,null,null],tricks:[null,null,null,null],scores:[0,0,0,0],roundTotalBets:0,bettingMode:null,timestamp:new Date().toISOString()}}setSimplifiedMode(e){this.simplifiedMode=e,this.activeRound&&(e&&this.activeRound.stage==="TRUMP"?this.activeRound.stage="BETS":!e&&this.activeRound.stage==="BETS"&&this.activeRound.bets.every(s=>s===null)&&(this.activeRound.stage="TRUMP")),this.notify()}getFirstBidderIndex(){return!this.simplifiedMode&&this.activeRound.trump.winnerIndex!==null&&!this.activeRound.trump.isPasRound?this.activeRound.trump.winnerIndex:(this.currentDealerIndex+1)%4}getLastBidderIndex(){return this.simplifiedMode?null:(this.getFirstBidderIndex()+3)%4}getBiddingOrder(){let e=this.getFirstBidderIndex();return[e,(e+1)%4,(e+2)%4,(e+3)%4]}getForbiddenBetForLastBidder(){if(this.simplifiedMode)return null;let e=this.getLastBidderIndex();if(e===null)return null;let s=[];for(let t=0;t<4;t++)t!==e&&typeof this.activeRound.bets[t]=="number"&&!isNaN(this.activeRound.bets[t])&&s.push(this.activeRound.bets[t]);if(s.length===3){let i=13-s.reduce((n,r)=>n+r,0);if(i>=0&&i<=13)return i}return null}setTrump(e,s,t,i=!1){this.activeRound.trump={winnerIndex:i?null:e,suitId:i?"NT":s,bidAmount:i?0:t,isPasRound:i},!i&&e!==null&&typeof e=="number"&&(this.activeRound.bets[e]===null||this.activeRound.bets[e]<t)&&(this.activeRound.bets[e]=t),this.activeRound.stage="BETS",this.notify()}setBet(e,s){if(e<0||e>3)return;this.activeRound.bets[e]=s;let t=this.activeRound.bets.filter(n=>typeof n=="number"&&!isNaN(n)),i=t.reduce((n,r)=>n+r,0);if(this.activeRound.roundTotalBets=i,t.length===4){let n=F(this.activeRound.bets);this.activeRound.bettingMode=n.status}else this.activeRound.bettingMode=i>13?"OVER":"UNDER";this.notify()}proceedToTricks(){if(this.activeRound.bets.filter(s=>typeof s=="number"&&!isNaN(s)).length!==4&&!this.activeRound.trump.isPasRound)throw new Error("All 4 players must submit bets.");if(this.rules.enforceHookRule&&!this.activeRound.trump.isPasRound&&!F(this.activeRound.bets).isValid)throw new Error("Total bets cannot equal 13 (Hook Rule). Please adjust the bids.");this.activeRound.stage="TRICKS",this.notify()}setTricks(e,s){e<0||e>3||(this.activeRound.tricks[e]=s,this.notify())}autoFillTricksFromBids(){let e=[],s=-1;for(let t=0;t<4;t++)typeof this.activeRound.tricks[t]=="number"&&!isNaN(this.activeRound.tricks[t])?e.push(this.activeRound.tricks[t]):s=t;if(e.length===3&&s!==-1){let t=13-e.reduce((i,n)=>i+n,0);if(t>=0&&t<=13)return this.activeRound.tricks[s]=t,this.notify(),!0}for(let t=0;t<4;t++){let i=this.activeRound.bets[t];this.activeRound.tricks[t]=typeof i=="number"&&!isNaN(i)?i:0}return this.notify(),!0}commitRound(){let e=this.activeRound.tricks;if(!ne(e))throw new Error("Total tricks must equal 13.");let s=[],t=this.activeRound.trump.isPasRound,i=this.activeRound.bets.reduce((r,l)=>r+(typeof l=="number"?l:0),0);for(let r=0;r<4;r++){let l=t?0:this.activeRound.bets[r],a=e[r],o=r===this.activeRound.trump.winnerIndex,d=j(l,a,o,t,this.rules,i);s.push({playerIndex:r,bid:l,tricks:a,score:d.score,made:d.made,delta:d.delta,explanation:d.explanation})}let n={...this.activeRound,simplified:this.simplifiedMode,results:s,scores:s.map(r=>r.score),cumulativeScores:this.calculateCumulativeAfterRound(s.map(r=>r.score)),completedAt:new Date().toISOString()};return this.completedRounds.push(n),this.checkGameEnd(),this.status!=="FINISHED"&&(this.currentDealerIndex=(this.currentDealerIndex+1)%4,this.roundNumber+=1,this.activeRound=this.initDraftRound()),this.notify(),n}calculateCumulativeAfterRound(e){return this.getCumulativeScores().map((t,i)=>t+e[i])}getCumulativeScores(){let e=[...this.initialScores];for(let s of this.completedRounds)for(let t=0;t<4;t++)e[t]+=s.scores&&typeof s.scores[t]=="number"?s.scores[t]:0;return e}setInitialScores(e){Array.isArray(e)&&e.length===4&&(this.initialScores=e.map(s=>parseInt(s,10)||0),this.recalculateAllScores())}recalculateAllScores(){let e=[...this.initialScores];for(let s=0;s<this.completedRounds.length;s++){let t=this.completedRounds[s],i=t.trump&&t.trump.isPasRound,n=a=>!t.simplified&&t.trump&&t.trump.winnerIndex===a,r=(t.bets||[]).reduce((a,o)=>a+(typeof o=="number"?o:0),0),l=[];for(let a=0;a<4;a++){let o=t.bets&&typeof t.bets[a]=="number"?t.bets[a]:0,d=t.tricks&&typeof t.tricks[a]=="number"?t.tricks[a]:0,c=j(o,d,n(a),i,this.rules,r);l.push({playerIndex:a,bid:o,tricks:d,score:c.score,made:c.made,explanation:c.explanation})}t.results=l,t.scores=l.map(a=>a.score),t.roundTotalBets=r,e=e.map((a,o)=>a+t.scores[o]),t.cumulativeScores=[...e]}this.checkGameEnd(),this.notify()}editCompletedRound(e,s={}){if(e<0||e>=this.completedRounds.length)throw new Error(`Invalid round index: ${e}`);let t=this.completedRounds[e];if(Array.isArray(s.bets)&&(t.bets=s.bets.map(i=>parseInt(i,10)||0),t.roundTotalBets=t.bets.reduce((i,n)=>i+n,0)),Array.isArray(s.tricks)){t.tricks=s.tricks.map(n=>parseInt(n,10)||0);let i=t.tricks.reduce((n,r)=>n+r,0);if(i!==13)throw new Error(`Total tricks must equal 13 (sum is ${i})`)}return s.dealerIndex!==void 0&&s.dealerIndex>=0&&s.dealerIndex<4&&(t.dealerIndex=s.dealerIndex,t.leadBidderIndex=(t.dealerIndex+1)%4),s.trump&&(t.trump={...t.trump,...s.trump}),this.recalculateAllScores(),t}deleteCompletedRound(e){if(e<0||e>=this.completedRounds.length)throw new Error(`Invalid round index: ${e}`);this.completedRounds.splice(e,1),this.completedRounds.forEach((s,t)=>{s.roundNumber=t+1}),this.roundNumber=this.completedRounds.length+1,this.activeRound&&(this.activeRound.roundNumber=this.roundNumber),this.recalculateAllScores()}getRankings(){let e=this.getCumulativeScores();return this.players.map((s,t)=>({index:t,player:s,score:e[t]})).sort((s,t)=>t.score-s.score)}checkGameEnd(){if(this.maxRounds&&this.completedRounds.length>=this.maxRounds){this.status="FINISHED";return}this.targetPoints&&this.getCumulativeScores().some(s=>s>=this.targetPoints)&&(this.status="FINISHED")}undoLastRound(){if(this.completedRounds.length===0)return!1;let e=this.completedRounds.pop();return this.roundNumber=e.roundNumber,this.currentDealerIndex=e.dealerIndex,this.activeRound={roundNumber:e.roundNumber,dealerIndex:e.dealerIndex,leadBidderIndex:e.leadBidderIndex,stage:"TRICKS",trump:{...e.trump},bets:[...e.bets],tricks:[...e.tricks],scores:[0,0,0,0],roundTotalBets:e.roundTotalBets,bettingMode:e.bettingMode,timestamp:e.timestamp},this.status="IN_PROGRESS",this.notify(),!0}updatePlayer(e,s,t){e>=0&&e<4&&(this.players[e]={...this.players[e],name:s||this.players[e].name,color:t||this.players[e].color},this.notify())}reorderPlayers(e){if(!Array.isArray(e)||e.length!==4)return;let s=[...this.players];this.players=e.map(i=>s[i]);let t=i=>i!=null&&i>=0&&i<4?e.indexOf(i):i;if(this.currentDealerIndex=t(this.currentDealerIndex),this.activeRound){if(this.activeRound.dealerIndex=t(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=t(this.activeRound.trump.winnerIndex)),Array.isArray(this.activeRound.bets)&&this.activeRound.bets.length===4){let i=[...this.activeRound.bets];this.activeRound.bets=e.map(n=>i[n])}if(Array.isArray(this.activeRound.tricks)&&this.activeRound.tricks.length===4){let i=[...this.activeRound.tricks];this.activeRound.tricks=e.map(n=>i[n])}if(Array.isArray(this.activeRound.scores)&&this.activeRound.scores.length===4){let i=[...this.activeRound.scores];this.activeRound.scores=e.map(n=>i[n])}}for(let i of this.completedRounds){if(i.dealerIndex=t(i.dealerIndex),i.leadBidderIndex!==void 0&&(i.leadBidderIndex=t(i.leadBidderIndex)),i.trump&&i.trump.winnerIndex!==null&&(i.trump.winnerIndex=t(i.trump.winnerIndex)),Array.isArray(i.scores)&&i.scores.length===4){let n=[...i.scores];i.scores=e.map(r=>n[r])}if(Array.isArray(i.cumulativeScores)&&i.cumulativeScores.length===4){let n=[...i.cumulativeScores];i.cumulativeScores=e.map(r=>n[r])}if(Array.isArray(i.results))for(let n of i.results)n.playerIndex=t(n.playerIndex)}if(Array.isArray(this.initialScores)&&this.initialScores.length===4){let i=[...this.initialScores];this.initialScores=e.map(n=>i[n])}this.notify()}swapPlayers(e,s){if(e===s||e<0||e>3||s<0||s>3)return;let t=this.players[e];if(this.players[e]=this.players[s],this.players[s]=t,Array.isArray(this.initialScores)&&this.initialScores.length===4){let n=this.initialScores[e];this.initialScores[e]=this.initialScores[s],this.initialScores[s]=n}let i=n=>n===e?s:n===s?e:n;if(this.currentDealerIndex=i(this.currentDealerIndex),this.activeRound){this.activeRound.dealerIndex=i(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=i(this.activeRound.trump.winnerIndex));let n=r=>{if(Array.isArray(r)&&r.length===4){let l=r[e];r[e]=r[s],r[s]=l}};n(this.activeRound.bets),n(this.activeRound.tricks),n(this.activeRound.scores)}for(let n of this.completedRounds){if(n.dealerIndex=i(n.dealerIndex),n.leadBidderIndex!==void 0&&(n.leadBidderIndex=i(n.leadBidderIndex)),n.trump&&n.trump.winnerIndex!==null&&(n.trump.winnerIndex=i(n.trump.winnerIndex)),Array.isArray(n.scores)&&n.scores.length===4){let r=n.scores[e];n.scores[e]=n.scores[s],n.scores[s]=r}if(Array.isArray(n.cumulativeScores)&&n.cumulativeScores.length===4){let r=n.cumulativeScores[e];n.cumulativeScores[e]=n.cumulativeScores[s],n.cumulativeScores[s]=r}if(Array.isArray(n.results))for(let r of n.results)r.playerIndex=i(r.playerIndex)}this.notify()}rotateSeatingClockwise(){let e=this.players[3];this.players=[e,this.players[0],this.players[1],this.players[2]];let s=t=>t!=null?(t+1)%4:t;if(this.currentDealerIndex=s(this.currentDealerIndex),this.activeRound){this.activeRound.dealerIndex=s(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=s(this.activeRound.trump.winnerIndex));let t=i=>[i[3],i[0],i[1],i[2]];this.activeRound.bets=t(this.activeRound.bets),this.activeRound.tricks=t(this.activeRound.tricks),this.activeRound.scores=t(this.activeRound.scores)}for(let t of this.completedRounds)if(t.dealerIndex=s(t.dealerIndex),t.leadBidderIndex!==void 0&&(t.leadBidderIndex=s(t.leadBidderIndex)),t.trump&&t.trump.winnerIndex!==null&&(t.trump.winnerIndex=s(t.trump.winnerIndex)),Array.isArray(t.scores)&&(t.scores=[t.scores[3],t.scores[0],t.scores[1],t.scores[2]]),Array.isArray(t.cumulativeScores)&&(t.cumulativeScores=[t.cumulativeScores[3],t.cumulativeScores[0],t.cumulativeScores[1],t.cumulativeScores[2]]),Array.isArray(t.results))for(let i of t.results)i.playerIndex=s(i.playerIndex);this.notify()}rotateSeatingCounterClockwise(){let e=this.players[0];this.players=[this.players[1],this.players[2],this.players[3],e];let s=t=>t!=null?(t+3)%4:t;if(this.currentDealerIndex=s(this.currentDealerIndex),this.activeRound){this.activeRound.dealerIndex=s(this.activeRound.dealerIndex),this.activeRound.leadBidderIndex=(this.activeRound.dealerIndex+1)%4,this.activeRound.trump&&this.activeRound.trump.winnerIndex!==null&&(this.activeRound.trump.winnerIndex=s(this.activeRound.trump.winnerIndex));let t=i=>[i[1],i[2],i[3],i[0]];this.activeRound.bets=t(this.activeRound.bets),this.activeRound.tricks=t(this.activeRound.tricks),this.activeRound.scores=t(this.activeRound.scores)}for(let t of this.completedRounds)if(t.dealerIndex=s(t.dealerIndex),t.leadBidderIndex!==void 0&&(t.leadBidderIndex=s(t.leadBidderIndex)),t.trump&&t.trump.winnerIndex!==null&&(t.trump.winnerIndex=s(t.trump.winnerIndex)),Array.isArray(t.scores)&&(t.scores=[t.scores[1],t.scores[2],t.scores[3],t.scores[0]]),Array.isArray(t.cumulativeScores)&&(t.cumulativeScores=[t.cumulativeScores[1],t.cumulativeScores[2],t.cumulativeScores[3],t.cumulativeScores[0]]),Array.isArray(t.results))for(let i of t.results)i.playerIndex=s(i.playerIndex);this.notify()}saveToStorage(){if(!(typeof localStorage>"u"))try{let e=JSON.stringify({id:this.id,createdAt:this.createdAt,rules:this.rules,targetPoints:this.targetPoints,maxRounds:this.maxRounds,simplifiedMode:this.simplifiedMode,players:this.players,currentDealerIndex:this.currentDealerIndex,roundNumber:this.roundNumber,completedRounds:this.completedRounds,initialScores:this.initialScores,activeRound:this.activeRound,status:this.status});localStorage.setItem(ee,e)}catch(e){console.warn("LocalStorage save failed:",e)}}static loadFromStorage(){if(typeof localStorage>"u")return new v;try{let e=localStorage.getItem(ee);if(e){let s=JSON.parse(e);return new v(s)}}catch(e){console.warn("LocalStorage load failed:",e)}return new v}static clearStorage(){if(!(typeof localStorage>"u"))try{localStorage.removeItem(ee)}catch(e){console.warn("LocalStorage clear failed:",e)}}exportJson(){return JSON.stringify({app:"Israeli Whist Scorekeeper",version:"1.0.0",exportedAt:new Date().toISOString(),session:{id:this.id,createdAt:this.createdAt,rules:this.rules,targetPoints:this.targetPoints,maxRounds:this.maxRounds,simplifiedMode:this.simplifiedMode,players:this.players,initialScores:this.initialScores,completedRounds:this.completedRounds,scores:this.getCumulativeScores(),rankings:this.getRankings()}},null,2)}};var O=class{constructor(e,s){this.app=e,this.onRemoteUpdate=s,this.roomId=this.detectRoomIdFromUrl(),this.ws=null,this.connected=!1,this.userCount=1,this.listeners=[],this.isApplyingRemote=!1,this.init()}detectRoomIdFromUrl(){let e=new URLSearchParams(window.location.search),s=e.get("game")||e.get("room");return!s&&window.location.hash&&(s=window.location.hash.replace("#","").trim()),s||this.generateFallbackCode()}generateFallbackCode(){let e="23456789ABCDEFGHJKLMNPQRSTUVWXYZ",s="";for(let t=0;t<4;t++)s+=e.charAt(Math.floor(Math.random()*e.length));return`W-${s}`}updateUrl(e){if(!e)return;let s=new URL(window.location.href);s.searchParams.set("game",e),window.history.replaceState({roomId:e},"",s.toString())}getShareUrl(){let e=new URL(window.location.href);return e.searchParams.set("game",this.roomId),e.toString()}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(s=>s!==e)}}notify(){for(let e of this.listeners)e({roomId:this.roomId,connected:this.connected,userCount:this.userCount,shareUrl:this.getShareUrl()})}init(){this.connectWebSocket()}connectWebSocket(){let e=window.location,s=e.protocol==="https:"?"wss:":"ws:",t="";e.pathname.startsWith("/whist-dev")?t="/whist-dev":e.pathname.startsWith("/whist")&&(t="/whist");let i=`${s}//${e.host}${t}/ws`;try{this.ws=new WebSocket(i),this.ws.onopen=()=>{this.connected=!0,this.notify(),this.joinRoom(this.roomId)},this.ws.onmessage=n=>{try{let r=JSON.parse(n.data);this.handleMessage(r)}catch(r){console.warn("Sync parse error:",r)}},this.ws.onclose=()=>{this.connected=!1,this.notify(),setTimeout(()=>this.connectWebSocket(),3e3)},this.ws.onerror=n=>{console.warn("WebSocket connection error:",n),this.connected=!1,this.notify()}}catch(n){console.warn("WebSocket init error:",n)}}joinRoom(e){this.roomId=e,this.updateUrl(e),this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify({type:"JOIN",roomId:e})),this.notify()}createNewRoom(){let e=this.generateFallbackCode();return this.roomId=e,this.updateUrl(e),this.ws&&this.ws.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify({type:"JOIN",roomId:e})),this.notify(),e}hasMeaningfulLocalState(){if(!this.app||!this.app.session)return!1;let e=this.app.session;if(e.completedRounds&&e.completedRounds.length>0||e.initialScores&&e.initialScores.some(i=>i!==0))return!0;let s=(i,n)=>!i||i===`Player ${n+1}`||i===`\u05E9\u05D7\u05E7\u05DF ${n+1}`;return!!((e.players||[]).some((i,n)=>!s(i.name,n))||e.activeRound&&(e.activeRound.bets&&e.activeRound.bets.some(i=>i!==null)||e.activeRound.tricks&&e.activeRound.tricks.some(i=>i!==null)))}handleMessage(e){e.type==="JOINED"?(this.userCount=e.userCount||1,this.notify(),e.state?(this.isApplyingRemote=!0,this.onRemoteUpdate(e.state),this.isApplyingRemote=!1):this.hasMeaningfulLocalState()&&this.broadcastLocalState()):e.type==="USER_COUNT_CHANGED"?(this.userCount=e.userCount||1,this.notify()):e.type==="STATE_UPDATED"&&(e.state&&(this.isApplyingRemote=!0,this.onRemoteUpdate(e.state),this.isApplyingRemote=!1),e.userCount&&(this.userCount=e.userCount,this.notify()))}broadcastLocalState(){if(this.isApplyingRemote||!this.ws||this.ws.readyState!==WebSocket.OPEN||!this.hasMeaningfulLocalState())return;let e={id:this.app.session.id,createdAt:this.app.session.createdAt,rules:this.app.session.rules,targetPoints:this.app.session.targetPoints,maxRounds:this.app.session.maxRounds,simplifiedMode:this.app.session.simplifiedMode,players:this.app.session.players,currentDealerIndex:this.app.session.currentDealerIndex,roundNumber:this.app.session.roundNumber,completedRounds:this.app.session.completedRounds,initialScores:this.app.session.initialScores,activeRound:this.app.session.activeRound,status:this.app.session.status};this.ws.send(JSON.stringify({type:"SYNC_STATE",roomId:this.roomId,state:e}))}switchRoom(e){this.joinRoom(e)}};var V="israeli_whist_recent_games_v1";var q=[],T=class{static getRecentGames(){if(q&&q.length>0)return q;if(typeof localStorage>"u")return[];try{let e=localStorage.getItem(V);if(e)return q=JSON.parse(e),q}catch(e){console.warn("Failed to read recent games archive:",e)}return[]}static getBasePath(){if(typeof window>"u")return"";let e=window.location;return e.pathname.startsWith("/whist-dev")?"/whist-dev":e.pathname.startsWith("/whist")?"/whist":""}static async syncWithServer(e=null){try{let t=`${this.getBasePath()}/api/recent-games`,i=await fetch(t);if(i.ok){let n=await i.json();if(n&&n.success&&Array.isArray(n.games)){let r=n.games,l=this.getRecentGames(),a=new Map;l.forEach(d=>{d&&d.roomId&&a.set(d.roomId,d)}),r.forEach(d=>{d&&d.roomId&&a.set(d.roomId,d)});let o=Array.from(a.values()).sort((d,c)=>new Date(c.updatedAt||c.createdAt)-new Date(d.updatedAt||d.createdAt)).slice(0,10);if(q=o,typeof localStorage<"u")try{localStorage.setItem(V,JSON.stringify(o))}catch{}return e&&e(o),o}}}catch(t){console.warn("Error syncing recent games with server:",t)}let s=this.getRecentGames();return e&&e(s),s}static saveGameToArchive(e,s){if(!e)return;let t=e.completedRounds?e.completedRounds.length:0,i=(a,o)=>!a||a===`Player ${o+1}`||a===`\u05E9\u05D7\u05E7\u05DF ${o+1}`,n=(e.players||[]).some((a,o)=>!i(a.name,o)),r=e.initialScores&&e.initialScores.some(a=>a!==0),l=e.activeRound&&(e.activeRound.bets&&e.activeRound.bets.some(a=>a!==null)||e.activeRound.tricks&&e.activeRound.tricks.some(a=>a!==null));if(!(t===0&&!n&&!l&&!r))try{let a=this.getRecentGames(),o=e.getCumulativeScores(),d=e.getRankings(),c=d.length>0?d[0]:null,h={roomId:s||e.id||"W-LOCAL",id:e.id,createdAt:e.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString(),roundNumber:e.roundNumber,completedRoundsCount:e.completedRounds?e.completedRounds.length:0,status:e.status||"IN_PROGRESS",simplifiedMode:e.simplifiedMode,players:e.players.map((g,p)=>({name:g.name,color:g.color,score:o[p]||0})),leaderName:c?c.player.name:e.players[0].name,leaderScore:c?c.score:0,fullState:{id:e.id,createdAt:e.createdAt,rules:e.rules,targetPoints:e.targetPoints,maxRounds:e.maxRounds,simplifiedMode:e.simplifiedMode,players:e.players,currentDealerIndex:e.currentDealerIndex,roundNumber:e.roundNumber,completedRounds:e.completedRounds,initialScores:e.initialScores,activeRound:e.activeRound,status:e.status}},m=a.filter(g=>g.roomId!==h.roomId&&g.id!==h.id),u=[h,...m].slice(0,10);q=u,typeof localStorage<"u"&&localStorage.setItem(V,JSON.stringify(u));let y=`${this.getBasePath()}/api/session/${h.roomId}`;fetch(y,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h.fullState)}).then(g=>g.json()).then(g=>{g&&g.rejected&&g.session&&typeof window<"u"&&window.__ISRAELI_WHIST_APP__&&(console.warn("[Sync] Server had an authoritative session; restoring state locally."),window.__ISRAELI_WHIST_APP__.applyRemoteState(g.session))}).catch(()=>{})}catch(a){console.warn("Failed to save game to archive:",a)}}static deleteGame(e){try{let t=this.getRecentGames().filter(n=>n.roomId!==e&&n.id!==e);q=t,typeof localStorage<"u"&&localStorage.setItem(V,JSON.stringify(t));let i=`${this.getBasePath()}/api/delete-session/${e}`;fetch(i).catch(()=>{})}catch(s){console.warn("Failed to delete game from archive:",s)}}static formatTimestamp(e){if(!e)return"";try{let s=new Date(e),t=new Date,i=s.toDateString()===t.toDateString(),n=s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return i?`Today at ${n}`:`${s.toLocaleDateString([],{month:"short",day:"numeric"})} \u2022 ${n}`}catch{return e}}};var W=class{constructor(e,s){this.app=e,this.container=s}render(){if(!this.container)return;let e=this.app.i18n,s=e.lang==="he",t=T.getRecentGames(),i=`
      ...
      ${t.length>0?`
        <div class="card" style="margin-top: 1.25rem;">
          ...
          <div style="display: flex; flex-direction: column; gap: 0.65rem;">
            ${t.slice(0,5).map((n,r)=>{let l=T.formatTimestamp(n.updatedAt||n.createdAt);return`
                <div style="background: rgba(0, 0, 0, 0.3); border: 1px solid var(--border-subtle); border-radius: var(--radius-md); padding: 0.75rem;">
                  ...
                  <div style="display: flex; justify-content: flex-end;">
                    <button class="btn-pill btn-share btn-landing-resume" data-game-idx="${r}" style="font-size: 0.75rem; padding: 0 12px; height: 30px;">
                      ${e.resumeMatch}
                    </button>
                  </div>
                </div>
    ...
    `;t==="TRUMP"&&!i?r+=this.renderTrumpStage(s):t==="BETS"?r+=this.renderBetsStage(s,i):t==="TRICKS"&&(r+=this.renderTricksStage(s,i)),r+="</div>",this.container.innerHTML=r,this.bindEvents(t,i)}renderTrumpStage(e){let s=this.i18n,t=s.lang==="he",i=this.session.players[e.dealerIndex],n=this.session.players[e.leadBidderIndex];return`
      <div>
        ...
        <div class="trump-stage-layout">
          ...
          <div class="trump-stage-col">
            ...
            <div class="suits-row">
              ${ie.map(r=>`
                <div class="suit-option ${e.trump.suitId===r.id&&!e.trump.isPasRound?"active":""}" data-suit-id="${r.id}">
                  <span class="suit-symbol" style="color: ${e.trump.suitId===r.id?"#ffffff":r.color}">${r.symbol}</span>
                  <span class="suit-label">${t?r.nameHe:r.nameEn}</span>
                </div>
              `).join("")}
            </div>
            ...
            <div class="trump-targets-grid">
              ${[5,6,7,8,9,10,11,12,13].map(r=>`
                <button class="chip ${e.trump.bidAmount===r&&!e.trump.isPasRound?"active":""} trump-target-chip" data-amount="${r}">
                  ${r}
                </button>
              `).join("")}
            </div>
    ...
    `}renderBetsStage(e,s){let t=this.i18n,i=this.session.getLastBidderIndex(),n=i!==null?this.session.players[i]:null,r=this.session.getForbiddenBetForLastBidder(),l=F(e.bets),a=e.bets.reduce((m,u)=>m+(typeof u=="number"&&!isNaN(u)?u:0),0),o=e.bets.every(m=>typeof m=="number"&&!isNaN(m)),d=this.session.players[e.dealerIndex],c=e.trump.winnerIndex!==null?this.session.players[e.trump.winnerIndex]:null,h="";return s?o&&a===13?h=t.hookViolation:h=`${t.totalBids}: <strong>${a}</strong> (${a>13?t.over:a<13?t.under:"13"})`:r!==null&&n?h=`${t.totalBids}: <strong>${a}</strong> \u2022 ${t.lastBidder} (${n.name}) ${t.lastBidderCannotBid} <strong>${r}</strong>`:h=`${t.totalBids}: <strong>${a}</strong> (${l.status==="OVER"?t.over:l.status==="UNDER"?t.under:"13"})`,`
      <div>
        ...
        <div class="round-inputs-grid">
          ${this.session.players.map((m,u)=>{let y=u===e.dealerIndex,g=!s&&u===i,p=!s&&u===e.trump.winnerIndex,S=e.bets[u],x=!s&&g&&r!==null;return`
              <div class="input-row ${y?"dealer-row":""}" data-player-idx="${u}">
                <div class="input-row-header">
                  <div class="input-row-name">
                    ...
                    ${g?`<span class="tag-dealer" style="position:static; background: #e11d48;">${t.lastBidder.toUpperCase()}</span>`:""}
                    ${y&&!p&&!g?`<span class="tag-dealer" style="position:static;">${t.dealer.toUpperCase()}</span>`:""}
                  </div>
                  
                  <div class="stepper">
                    <button class="stepper-btn btn-bet-dec" data-player-idx="${u}" ${S===null||S<=0?"disabled":""}>\u2212</button>
                    <span class="stepper-val">${S!==null?S:"\u2014"}</span>
                    <button class="stepper-btn btn-bet-inc" data-player-idx="${u}" ${S>=13?"disabled":""}>+</button>
                  </div>
                </div>

                <div class="chips-row">
                  ${[0,1,2,3,4,5,6,7,8].map(w=>`
                    <button class="chip ${S===w?"active":""} ${x&&r===w?"forbidden":""}" 
                            data-player-idx="${u}" data-amount="${w}">
                      ${w===0?"0":w}
                    </button>
                  `).join("")}
                </div>
    ...
    `}renderTricksStage(e,s){let t=this.i18n,i=e.tricks,n=i.reduce((a,o)=>a+(typeof o=="number"&&!isNaN(o)?o:0),0),r=n===13&&i.every(a=>typeof a=="number"&&!isNaN(a)),l=13-n;return`
      <div>
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.65rem;">
          <div style="font-size: 0.82rem; font-weight: 700; color: ${r?"var(--success)":"var(--warning)"};">
            ${r?t.tricksValid:`${t.remainingToAssign}: ${l}`}
          </div>
        ...
        <div class="round-inputs-grid">
          ${this.session.players.map((a,o)=>{let d=e.bets[o],c=i[o],h=c!==null&&d!==null&&c===d;return`
              <div class="input-row" data-player-idx="${o}" style="${h?"border-color: rgba(16, 185, 129, 0.4);":""}">
                <div class="input-row-header">
                  <div class="input-row-name">
                    <span class="player-dot" style="background: ${a.color};"></span>
                    <span>${a.name}</span>
                    ...
                    ${h?`<span style="color: var(--success); font-size: 0.72rem; font-weight: 700; margin-left: 2px;">${t.exact}</span>`:""}
                  </div>
                ...
                <div class="chips-row">
                  ${[0,1,2,3,4,5,6,7,8].map(m=>`
                    <button class="chip ${c===m?"active":""}" 
                            data-trick-player-idx="${o}" data-amount="${m}">
                      ${m}
                    </button>
                  `).join("")}
                </div>
        ...
        ${r?this.renderScorePreview(e):""}

        <div style="display: flex; gap: 0.4rem; margin-top: 0.85rem;">
          <button class="btn-outline" id="btn-back-to-bets" style="flex: 1;">
            ${t.editBids}
          </button>
          <button class="btn-block" id="btn-commit-round" style="flex: 2;" ${r?"":"disabled"}>
            ${t.calculateNextDeal}
          </button>
        </div>
      </div>
    `}renderScorePreview(e){let s=this.i18n,t=e.bets.reduce((n,r)=>n+(typeof r=="number"?r:0),0),i=e.trump?e.trump.isPasRound:!1;return`
      <div class="breakdown-box">
        ...
        <div class="breakdown-items-grid">
          ${this.session.players.map((n,r)=>{let l=j(e.bets[r]||0,e.tricks[r]||0,r===(e.trump?e.trump.winnerIndex:null),i,this.session.rules,t);return`
              <div class="breakdown-item">
                <div>
                  <div style="font-size: 0.82rem; font-weight: 700;">${n.name}</div>
    ...
    `}bindEvents(e,s){let t=this.container.querySelector("#btn-toggle-simplified");if(t&&t.addEventListener("click",()=>{M(),this.session.setSimplifiedMode(!this.session.simplifiedMode),this.render()}),e==="TRUMP"&&!s){this.container.querySelectorAll(".trump-player-btn").forEach(r=>{r.addEventListener("click",()=>{M();let l=parseInt(r.dataset.playerIdx,10);this.session.activeRound.trump.winnerIndex=l,this.session.activeRound.trump.isPasRound=!1,this.render()})}),this.container.querySelectorAll(".suit-option").forEach(r=>{r.addEventListener("click",()=>{M();let l=r.dataset.suitId;this.session.activeRound.trump.suitId=l,this.session.activeRound.trump.isPasRound=!1,this.render()})}),this.container.querySelectorAll(".trump-target-chip").forEach(r=>{r.addEventListener("click",()=>{M(),this.session.activeRound.trump.bidAmount=parseInt(r.dataset.amount,10),this.session.activeRound.trump.isPasRound=!1,this.render()})});let i=this.container.querySelector("#chk-pas-round");i&&i.addEventListener("change",r=>{M(),this.session.activeRound.trump.isPasRound=r.target.checked,r.target.checked&&(this.session.activeRound.trump.winnerIndex=null),this.render()});let n=this.container.querySelector("#btn-confirm-trump");n&&n.addEventListener("click",()=>{M();let r=this.session.activeRound.trump;this.session.setTrump(r.winnerIndex,r.suitId,r.bidAmount,r.isPasRound),this.render()})}else if(e==="BETS"){this.container.querySelectorAll(".chip[data-player-idx]").forEach(r=>{r.addEventListener("click",()=>{M();let l=parseInt(r.dataset.playerIdx,10),a=parseInt(r.dataset.amount,10);this.session.setBet(l,a),this.render()})}),this.container.querySelectorAll(".btn-bet-dec").forEach(r=>{r.addEventListener("click",()=>{M();let l=parseInt(r.dataset.playerIdx,10),a=this.session.activeRound.bets[l]||0;a>0&&(this.session.setBet(l,a-1),this.render())})}),this.container.querySelectorAll(".btn-bet-inc").forEach(r=>{r.addEventListener("click",()=>{M();let l=parseInt(r.dataset.playerIdx,10),a=this.session.activeRound.bets[l]??-1;a<13&&(this.session.setBet(l,a+1),this.render())})});let i=this.container.querySelector("#btn-back-to-trump");i&&i.addEventListener("click",()=>{M(),this.session.activeRound.stage="TRUMP",this.render()});let n=this.container.querySelector("#btn-proceed-to-tricks");n&&n.addEventListener("click",()=>{M();try{this.session.proceedToTricks(),this.render()}catch(r){alert(r.message)}})}else if(e==="TRICKS"){this.container.querySelectorAll(".chip[data-trick-player-idx]").forEach(l=>{l.addEventListener("click",()=>{M();let a=parseInt(l.dataset.trickPlayerIdx,10),o=parseInt(l.dataset.amount,10);this.session.setTricks(a,o),this.render()})}),this.container.querySelectorAll(".btn-trick-dec").forEach(l=>{l.addEventListener("click",()=>{M();let a=parseInt(l.dataset.playerIdx,10),o=this.session.activeRound.tricks[a]||0;o>0&&(this.session.setTricks(a,o-1),this.render())})}),this.container.querySelectorAll(".btn-trick-inc").forEach(l=>{l.addEventListener("click",()=>{M();let a=parseInt(l.dataset.playerIdx,10),o=this.session.activeRound.tricks[a]??-1;o<13&&(this.session.setTricks(a,o+1),this.render())})});let i=this.container.querySelector("#btn-auto-fill-tricks");i&&i.addEventListener("click",()=>{M(),this.session.autoFillTricksFromBids(),this.render()});let n=this.container.querySelector("#btn-back-to-bets");n&&n.addEventListener("click",()=>{M(),this.session.activeRound.stage="BETS",this.render()});let r=this.container.querySelector("#btn-commit-round");r&&r.addEventListener("click",()=>{M();try{this.session.commitRound(),this.onRoundComplete&&this.onRoundComplete(),this.render()}catch(l){alert(l.message)}})}}};var Y=class{constructor(e,s,t,i,n,r,l,a){this.session=e,this.leaderboardContainer=s,this.historyContainer=t,this.i18n=i,this.onUndo=n,this.onReorganizeSeating=r,this.onEditDeal=l,this.onSetBaseline=a,this.isJiggleMode=!1,this.isDragging=!1,document.addEventListener("pointerup",o=>{this.isJiggleMode&&!this.isDragging&&(o.target.closest(".player-card")||this.setJiggleMode(!1))}),this.render()}updateSession(e){this.session=e,!this.isDragging&&!this.isJiggleMode&&this.render()}updateI18n(e){this.i18n=e,!this.isDragging&&!this.isJiggleMode&&this.render()}setJiggleMode(e){if(this.isJiggleMode=e,this.leaderboardContainer){let s=this.leaderboardContainer.querySelector(".leaderboard-grid");s&&s.classList.toggle("is-jiggling",e)}e||this.renderLeaderboard()}render(){this.renderLeaderboard(),this.renderHistoryTable()}renderLeaderboard(){if(!this.leaderboardContainer)return;let e=this.i18n,s=this.session.getRankings(),t=this.session.getCumulativeScores(),i=s.length>0?s[0].score:0,n=this.session.currentDealerIndex,r=`
      <div class="leaderboard-grid ${this.isJiggleMode?"is-jiggling":""}">
        ${this.session.players.map((l,a)=>{let o=t[a],d=s.findIndex(m=>m.index===a),c=o===i&&this.session.completedRounds.length>0,h=a===n;return`
            <div class="player-card ${c?"is-leader":""} ${h?"is-dealer":""}" 
                 data-player-idx="${a}" 
                 title="Long-press to lift and reorder seating">
              ${h?`<span class="tag-dealer">${e.dealer.toUpperCase()}</span>`:""}
    ...
    `;this.leaderboardContainer.innerHTML=r,this.bindLeaderboardEvents()}bindLeaderboardEvents(){if(!this.leaderboardContainer)return;let e=this.leaderboardContainer.querySelector(".leaderboard-grid");Array.from(this.leaderboardContainer.querySelectorAll(".player-card")).forEach(t=>{let i=null,n=0,r=0,l=0,a=0,o=0,d=0,c=0,h=!1,m=null,u=null,y=[],g=null,p=null,S=(b=25)=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(b)}catch{}},x=()=>Array.from(e.querySelectorAll(".player-card")).map(R=>{let $=R.getBoundingClientRect();return{left:$.left,top:$.top,width:$.width,height:$.height,centerX:$.left+$.width/2,centerY:$.top+$.height/2}}),w=b=>{if(b==null)return;let R=Array.from(e.querySelectorAll(".player-card")),$=[0,1,2,3],[k]=$.splice(m,1);$.splice(b,0,k),R.forEach((H,B)=>{if(B===m)return;let L=$.indexOf(B),P=y[B],N=y[L];if(P&&N){let K=N.left-P.left,A=N.top-P.top;H.style.transform=`translate3d(${K}px, ${A}px, 0)`}})},f=()=>{Array.from(e.querySelectorAll(".player-card")).forEach(R=>{R.style.transform="",R.style.zIndex=""})},I=()=>{if(!h)return;let b=l-n,R=a-r;d+=(c-d)*.18,t.style.transform=`translate3d(${b}px, ${R-8}px, 0) scale(1.12) rotate(${d.toFixed(2)}deg)`;let $=y[m],k=$.centerX+b,H=$.centerY+R,B=u,L=1/0;y.forEach((P,N)=>{let _=Math.hypot(k-P.centerX,H-P.centerY)*(N===u?.75:1);_<L&&(L=_,B=N)}),B!==u&&(u=B,S(18),w(u)),p=requestAnimationFrame(I)},E=(b,R)=>{this.isDragging||(this.isDragging=!0,h=!0,m=parseInt(t.dataset.playerIdx,10),u=m,y=x(),this.setJiggleMode(!0),t.classList.remove("card-pressing"),t.classList.add("is-lifted"),t.style.zIndex="500",S([40,60,40]),l=b,a=R,o=b,d=0,c=0,t.style.transform=`translate3d(${b-n}px, ${R-r-8}px, 0) scale(1.12)`,p=requestAnimationFrame(I))},C=b=>{if(g!==null&&b.pointerId!==g)return;let R=b.clientX,$=b.clientY;if(!h){(Math.abs(R-n)>10||Math.abs($-r)>10)&&(i&&(clearTimeout(i),i=null),t.classList.remove("card-pressing"));return}b.preventDefault(),b.stopPropagation(),l=R,a=$;let k=R-o;o=R,c=Math.max(-7,Math.min(7,k*.4))},D=b=>{if(!(g!==null&&b.pointerId!==g)){if(i&&(clearTimeout(i),i=null),t.classList.remove("card-pressing"),g=null,p&&(cancelAnimationFrame(p),p=null),h){h=!1,this.isDragging=!1;let R=u,$=y[m],k=y[R];if($&&k&&m!==R){let H=k.left-$.left,B=k.top-$.top;t.classList.add("is-dropping"),t.style.transform=`translate3d(${H}px, ${B}px, 0) scale(1.0) rotate(0deg)`,S(30);let L=[0,1,2,3],[P]=L.splice(m,1);L.splice(R,0,P),this.session.reorderPlayers(L),setTimeout(()=>{t.classList.remove("is-lifted","is-dropping");let N=Array.from(e.querySelectorAll(".player-card"));L.map(A=>N[A]).forEach((A,_)=>{A.dataset.playerIdx=_,A.style.transform="",A.style.zIndex="",e.appendChild(A)}),f()},260)}else t.classList.remove("is-lifted"),f()}window.removeEventListener("pointermove",C),window.removeEventListener("pointerup",D),window.removeEventListener("pointercancel",D)}},U=b=>{this.isDragging||(g=b.pointerId,n=b.clientX,r=b.clientY,l=b.clientX,a=b.clientY,o=b.clientX,t.classList.add("card-pressing"),window.addEventListener("pointermove",C,{passive:!1}),window.addEventListener("pointerup",D),window.addEventListener("pointercancel",D),this.isJiggleMode?E(n,r):i=setTimeout(()=>{E(n,r)},260))};t.addEventListener("pointerdown",U),t.addEventListener("contextmenu",b=>b.preventDefault())})}renderHistoryTable(){if(!this.historyContainer)return;let e=this.i18n,s=this.session.completedRounds,t=this.session.initialScores&&this.session.initialScores.some(a=>a!==0);if(s.length===0){this.historyContainer.innerHTML=`
            ...
            <tbody>
              ${s.map((a,o)=>{let d=this.session.players[a.dealerIndex];return`
                  <tr>
                    ...
                    ${this.session.players.map((c,h)=>{let m=a.results.find(p=>p.playerIndex===h);if(!m)return"<td>\u2014</td>";let u=m.score>=0?`+${m.score}`:m.score,y=m.made,g=a.cumulativeScores?a.cumulativeScores[h]:"\u2014";return`
                        <td>
    ...
    `;this.historyContainer.innerHTML=i;let n=this.historyContainer.querySelector("#btn-undo-round");n&&n.addEventListener("click",()=>{confirm(e.undoConfirm)&&this.onUndo&&this.onUndo()});let r=this.historyContainer.querySelector("#btn-set-baseline");r&&r.addEventListener("click",()=>{this.onSetBaseline&&this.onSetBaseline()});let l=this.historyContainer.querySelector(".btn-edit-baseline");l&&l.addEventListener("click",()=>{this.onSetBaseline&&this.onSetBaseline()}),this.historyContainer.querySelectorAll(".btn-edit-deal").forEach(a=>{a.addEventListener("click",()=>{let o=parseInt(a.dataset.roundIdx,10);!isNaN(o)&&this.onEditDeal&&this.onEditDeal(o)})})}};var X=class{constructor(e,s,t){this.session=e,this.container=s,this.i18n=t,this.render()}updateSession(e){this.session=e,this.render()}updateI18n(e){this.i18n=e,this.render()}render(){if(!this.container)return;let e=this.session.completedRounds;if(e.length===0){this.container.innerHTML="";return}let s=this.session.players,t=["Start",...e.map(f=>`R${f.roundNumber}`)],i=t.length,n=s.map((f,I)=>{let E=this.session.initialScores&&this.session.initialScores[I]||0,C=[E];return e.forEach(D=>{let U=D.results.find(b=>b.playerIndex===I);E+=U?U.score:0,C.push(E)}),{player:f,points:C}}),r=0,l=0;n.forEach(f=>{f.points.forEach(I=>{I<r&&(r=I),I>l&&(l=I)})});let a=20;r=Math.floor((r-a)/20)*20,l=Math.ceil((l+a)/20)*20,r===l&&(l+=50);let o=600,d=240,c=40,h=20,m=20,u=30,y=o-c-h,g=d-m-u,p=f=>c+f/(i-1||1)*y,S=f=>m+g-(f-r)/(l-r)*g,x=S(0),w=`
      <div class="card">
        ...
        <div style="overflow-x: auto;">
          <svg viewBox="0 0 ${o} ${d}" style="width: 100%; max-width: 600px; height: auto; display: block; margin: 0 auto;">
            <!-- Zero axis -->
            <line x1="${c}" y1="${x}" x2="${o-h}" y2="${x}" stroke="rgba(255,255,255,0.2)" stroke-width="1" stroke-dasharray="3 3" />
            <text x="${c-6}" y="${x+3}" fill="var(--text-muted)" font-size="9" text-anchor="end">0</text>
            <text x="${c-6}" y="${m+6}" fill="var(--text-muted)" font-size="9" text-anchor="end">${l}</text>
            <text x="${c-6}" y="${d-u}" fill="var(--text-muted)" font-size="9" text-anchor="end">${r}</text>

            ${t.map((f,I)=>`
              <text x="${p(I)}" y="${d-10}" fill="var(--text-muted)" font-size="9" text-anchor="middle">${f}</text>
            `).join("")}

            ${n.map(f=>{let I=f.points.map((E,C)=>`${p(C)},${S(E)}`).join(" ");return`
                <polyline fill="none" stroke="${f.player.color}" stroke-width="2" points="${I}" />
                ${f.points.map((E,C)=>`
                  <circle cx="${p(C)}" cy="${S(E)}" r="3.5" fill="${f.player.color}" stroke="#111827" stroke-width="1.5">
                    <title>${f.player.name}: ${E}</title>
                  </circle>
                `).join("")}
              `}).join("")}
          </svg>
    ...
    `;this.container.innerHTML=w}};function re(v){let e=v.completedRounds,s=e.length,i=v.players.map((o,d)=>{let c=0,h=0,m=0,u=0,y=0,g=0,p=0,S=0,x=0,w=-1/0,f=1/0,I=[0],E=0;e.forEach($=>{let k=$.results.find(H=>H.playerIndex===d);k&&(c+=k.score,E+=k.score,I.push(E),m++,u+=k.bid||0,y+=k.tricks||0,k.made&&h++,k.bid===0&&(g++,k.made&&p++),$.trump.winnerIndex===d&&(S++,k.made&&x++),k.score>w&&(w=k.score),k.score<f&&(f=k.score))});let C=m>0?h/m*100:0,D=s>0?y/s:0,U=m>0?u/m:0,b=g>0?p/g*100:0,R=S>0?x/S*100:0;return{player:o,pIdx:d,totalScore:c,madeBidsCount:h,totalBidsCount:m,hitRate:Math.round(C*10)/10,totalTricksWon:y,avgTricksPerRound:Math.round(D*10)/10,avgBidPerRound:Math.round(U*10)/10,zeroAttempts:g,zeroSuccess:p,zeroRate:Math.round(b*10)/10,passAttempts:g,passSuccess:p,passRate:Math.round(b*10)/10,trumpMakerCount:S,trumpMakerSuccess:x,trumpRate:Math.round(R*10)/10,highestSingleRound:w===-1/0?0:w,lowestSingleRound:f===1/0?0:f,roundScoresHistory:I}}),n=0,r=0,l=0;e.forEach(o=>{o.trump.isPasRound?l++:o.roundTotalBets>13?n++:o.roundTotalBets<13&&r++});let a=[...i].sort((o,d)=>d.totalScore-o.totalScore);return{numRounds:s,rankings:a,playerStats:i,overRoundsCount:n,underRoundsCount:r,pasRoundsCount:l,mostAccuratePlayer:[...i].sort((o,d)=>d.hitRate-o.hitRate)[0],mostAggressiveBidder:[...i].sort((o,d)=>d.avgBidPerRound-o.avgBidPerRound)[0],masterOfZero:[...i].sort((o,d)=>d.zeroSuccess-o.zeroSuccess)[0],masterOfPass:[...i].sort((o,d)=>d.zeroSuccess-o.zeroSuccess)[0]}}var Z=class{constructor(e){this.app=e}showMenuModal(){let e=this.app.i18n,s=e.lang==="he",t=this.app.session.simplifiedMode,i=T.getRecentGames(),n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
      <div class="modal-box">
    ...
    `,document.body.appendChild(n);let r=()=>n.remove();n.querySelectorAll(".modal-close").forEach(l=>l.addEventListener("click",r)),n.querySelector("#menu-opt-toggle-lang").addEventListener("click",()=>{r(),this.app.setLanguage(s?"en":"he")}),n.querySelector("#menu-opt-home-lobby").addEventListener("click",()=>{r(),this.app.showLandingView()}),n.querySelector("#menu-opt-baseline").addEventListener("click",()=>{r(),this.showBaselineModal()}),n.querySelector("#menu-opt-saved-games").addEventListener("click",()=>{r(),this.showSavedGamesModal()}),n.querySelector("#menu-opt-edit-players").addEventListener("click",()=>{r(),this.showEditSettingsModal()}),n.querySelector("#menu-opt-toggle-mode").addEventListener("click",()=>{this.app.session.setSimplifiedMode(!this.app.session.simplifiedMode),r()}),n.querySelector("#menu-opt-new-game").addEventListener("click",()=>{r(),this.showNewGameModal()}),n.querySelector("#menu-opt-share").addEventListener("click",()=>{r(),this.showShareModal()}),n.querySelector("#menu-opt-stats").addEventListener("click",()=>{r(),this.showStatsModal()}),n.querySelector("#menu-opt-export").addEventListener("click",()=>{r(),this.showExportModal()})}showReorganizeSeatingModal(e=null){let s=this.app.i18n,t=this.app.session,i=e!==null?e:null,n=document.createElement("div");n.className="modal-overlay";let r=()=>{let l=d=>t.currentDealerIndex===d;n.innerHTML=`
        <div class="modal-box" style="max-width: 460px;">
          ...
          <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg); padding: 1rem 0.75rem; margin: 0.75rem 0; position: relative;">
            ...
            <div class="leaderboard-grid seating-modal-grid" style="margin-bottom: 0;">
              ${t.players.map((d,c)=>{let h=i===c,m=l(c);return`
                  <div class="player-card seat-swap-card ${h?"seat-selected":""} ${m?"is-dealer":""}" 
                       data-seat-idx="${c}" 
                       style="cursor: pointer; transition: all 0.18s ease; ${h?"border: 2px solid #fbbf24; background: rgba(251, 191, 36, 0.15); transform: scale(1.04);":""}">
                    ...
                    <div style="font-size: 0.72rem; color: ${h?"#fde68a":"var(--accent-primary)"}; font-weight: 700; margin-top: 4px;">
                      ${h?"\u2713 Selected":"Tap to Swap"}
                    </div>
                  </div>
                `}).join("")}
            </div>
      ...
      `,n.querySelectorAll(".modal-close").forEach(d=>d.addEventListener("click",()=>n.remove())),n.querySelectorAll(".seat-swap-card").forEach(d=>{d.addEventListener("click",()=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}let c=parseInt(d.dataset.seatIdx,10);i===null?(i=c,r()):i===c?(i=null,r()):(t.swapPlayers(i,c),i=null,r())})});let a=n.querySelector("#btn-rot-cw");a&&a.addEventListener("click",()=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}t.rotateSeatingClockwise(),r()});let o=n.querySelector("#btn-rot-ccw");o&&o.addEventListener("click",()=>{if(typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(15)}catch{}t.rotateSeatingCounterClockwise(),r()})};r(),document.body.appendChild(n)}showSavedGamesModal(){let e=this.app.i18n,s=e.lang==="he",t=T.getRecentGames(),i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
      <div class="modal-box" style="max-width: 480px;">
        ...
        `:`
          <div style="display: flex; flex-direction: column; gap: 0.65rem; margin-bottom: 1rem; max-height: 55vh; overflow-y: auto;">
            ${t.map((r,l)=>{let a=T.formatTimestamp(r.updatedAt||r.createdAt),o=this.app.syncManager&&this.app.syncManager.roomId===r.roomId;return`
                <div style="background: rgba(0, 0, 0, 0.3); border: 1px solid ${o?"var(--accent-primary)":"var(--border-subtle)"}; border-radius: var(--radius-md); padding: 0.75rem;">
                  ...
                  <div style="display: flex; gap: 0.4rem; justify-content: flex-end;">
                    <button class="btn-pill btn-delete-game" data-room-id="${r.roomId}" style="color: var(--danger); border-color: rgba(239, 68, 68, 0.3); font-size: 0.72rem;">
                      ${e.delete}
                    </button>
    ...
    `,document.body.appendChild(i);let n=()=>i.remove();i.querySelectorAll(".modal-close").forEach(r=>r.addEventListener("click",n)),i.querySelectorAll(".btn-resume-game").forEach(r=>{r.addEventListener("click",()=>{let l=parseInt(r.dataset.gameIdx,10),a=t[l];a&&(this.app.resumeGameFromArchive(a),n())})}),i.querySelectorAll(".btn-delete-game").forEach(r=>{r.addEventListener("click",l=>{l.stopPropagation();let a=r.dataset.roomId;confirm(`${e.deleteConfirm} (${a})`)&&(T.deleteGame(a),n(),this.showSavedGamesModal())})})}showEditSettingsModal(e=null){let s=this.app.i18n,t=s.lang==="he",i=this.app.session,n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
      <div class="modal-box">
        <div class="modal-head">
    ...
    `,document.body.appendChild(n);let r=()=>n.remove();if(n.querySelectorAll(".modal-close").forEach(l=>l.addEventListener("click",r)),e!==null){let l=n.querySelector(`.edit-player-name-input[data-p-idx="${e}"]`);l&&setTimeout(()=>{l.focus(),l.select()},100)}n.querySelector("#btn-save-settings").addEventListener("click",()=>{let l=n.querySelectorAll(".edit-player-name-input"),a=parseInt(n.querySelector("#edit-dealer-select").value,10),o=n.querySelector("#edit-mode-select").value==="SIMPLIFIED",d=n.querySelector("#edit-rule-select").value,c=n.querySelector("#chk-edit-hook").checked;i.players.forEach((h,m)=>{let u=l[m].value.trim();u&&(h.name=u)}),i.currentDealerIndex=a,i.activeRound&&(i.activeRound.dealerIndex=a,i.activeRound.leadBidderIndex=(a+1)%4),i.rules={...z[d],enforceHookRule:c},i.setSimplifiedMode(o),i.notify(),r()})}showShareModal(){let e=this.app.i18n,s=this.app.syncManager;this.app.session&&(this.app.archiveCurrentGame(),s&&s.broadcastLocalState());let t=s?s.getShareUrl():window.location.href,i=s?s.roomId:"Local",n=`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(t)}`,r=document.createElement("div");r.className="modal-overlay",r.innerHTML=`
      <div class="modal-box">
        <div class="modal-head">
          <div>
    ...
    `,document.body.appendChild(r);let l=()=>r.remove();r.querySelectorAll(".modal-close").forEach(o=>o.addEventListener("click",l)),r.querySelector("#btn-copy-url").addEventListener("click",()=>{navigator.clipboard.writeText(t);let o=r.querySelector("#btn-copy-url");o.textContent=e.copied,setTimeout(()=>o.textContent=e.copy,2e3)});let a=r.querySelector("#btn-native-share");a&&a.addEventListener("click",()=>{navigator.share({title:e.appTitle,text:`${e.shareTitle} (${i})`,url:t}).catch(()=>{})})}showNewGameModal(){let e=this.app.i18n,s=e.lang==="he",t=this.app.session,i=T.getRecentGames(),n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
      <div class="modal-box">
        <div class="modal-head">
    ...
    `,document.body.appendChild(n);let r=()=>n.remove();n.querySelectorAll(".modal-close").forEach(a=>a.addEventListener("click",r));let l=n.querySelector("#btn-open-recent-from-new");l&&l.addEventListener("click",()=>{r(),this.showSavedGamesModal()}),n.querySelector("#btn-start-new-game").addEventListener("click",()=>{let a=n.querySelectorAll(".player-name-input"),o=n.querySelector("#chk-new-game-simplified").checked,d=n.querySelector("#new-game-rule-select").value,c=n.querySelector("#new-game-target-select").value,h=t.players.map((p,S)=>({...p,name:a[S].value.trim()||p.name})),m=n.querySelectorAll(".new-game-baseline-input"),u=[];m.forEach(p=>{u.push(parseInt(p.value,10)||0)});let y=null,g=null;c==="13_ROUNDS"?y=13:c==="16_ROUNDS"?y=16:c==="TARGET_500"?g=500:c==="TARGET_1000"&&(g=1e3),this.app.startNewGame({players:h,rules:{...z[d]},maxRounds:y,targetPoints:g,simplifiedMode:o,initialScores:u}),r()})}showStatsModal(){let e=this.app.i18n,s=this.app.session,t=re(s),i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
      <div class="modal-box">
        <div class="modal-head">
            ...
            <div style="background: rgba(0,0,0,0.2); padding: 0.6rem 0.75rem; border-radius: var(--radius-md); border: 1px solid var(--border-subtle);">
              <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.2rem;">
                <span style="font-weight: 700; font-size: 0.82rem;">
                  <span class="player-dot" style="background: ${r.player.color};"></span>
                  ${r.player.name}
                </span>
                <span style="font-weight: 800; font-size: 0.82rem; color: ${r.hitRate>=50?"var(--success)":"var(--warning)"};">${r.hitRate}%</span>
              </div>
              <div style="display: flex; justify-content: space-between; font-size: 0.72rem; color: var(--text-muted);">
                <span>${e.made}: ${r.madeBidsCount}/${r.totalBidsCount}</span>
                <span>${e.avgTricksPerDeal}: ${r.avgTricksPerRound}</span>
                <span>${e.passSuccess}: ${r.passSuccess}/${r.passAttempts}</span>
              </div>
            </div>
          `).join("")}
        </div>
    ...
    `,document.body.appendChild(i);let n=()=>i.remove();i.querySelectorAll(".modal-close").forEach(r=>r.addEventListener("click",n))}showExportModal(){let e=this.app.i18n,s=this.app.session,t=s.exportJson(),i=s.getRankings(),n=`Israeli Whist Match Results
`;n+=`Rounds: ${s.completedRounds.length}

`,i.forEach((a,o)=>{n+=`#${o+1} ${a.player.name}: ${a.score>=0?"+":""}${a.score} pts
`});let r=document.createElement("div");r.className="modal-overlay",r.innerHTML=`
      <div class="modal-box">
        <div class="modal-head">
    ...
    `,document.body.appendChild(r);let l=()=>r.remove();r.querySelectorAll(".modal-close").forEach(a=>a.addEventListener("click",l)),r.querySelector("#btn-copy-share").addEventListener("click",()=>{navigator.clipboard.writeText(n),alert(e.copied||"Copied to clipboard.")}),r.querySelector("#btn-copy-json").addEventListener("click",()=>{navigator.clipboard.writeText(t),alert(e.copied||"JSON copied to clipboard.")})}showBaselineModal(){let e=this.app.i18n,s=e.lang==="he",t=this.app.session,i=t.initialScores||[0,0,0,0],n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
    ...
    `,document.body.appendChild(n);let r=()=>n.remove();n.querySelectorAll(".modal-close").forEach(l=>l.addEventListener("click",r)),n.querySelector("#btn-save-baseline").addEventListener("click",()=>{let l=n.querySelectorAll(".baseline-score-input"),a=[];l.forEach(o=>{a.push(parseInt(o.value,10)||0)}),t.setInitialScores(a),r()})}showEditDealModal(e){let s=this.app.i18n,t=s.lang==="he",i=this.app.session;if(e<0||e>=i.completedRounds.length)return;let n=i.completedRounds[e],r=[...n.bets],l=[...n.tricks],a=n.dealerIndex,o=document.createElement("div");o.className="modal-overlay";let d=()=>{let u=l.reduce((x,w)=>x+(parseInt(w,10)||0),0),y=r.reduce((x,w)=>x+(parseInt(w,10)||0),0),g=n.trump&&n.trump.isPasRound,p=x=>!n.simplified&&n.trump&&n.trump.winnerIndex===x,S=[];for(let x=0;x<4;x++){let w=parseInt(r[x],10)||0,f=parseInt(l[x],10)||0,I=j(w,f,p(x),g,i.rules,y);S.push(I)}return{sumTricks:u,sumBets:y,playerScores:S}},c=()=>{let{sumTricks:u,sumBets:y,playerScores:g}=d(),p=o.querySelector("#edit-tricks-sum-badge"),S=o.querySelector("#edit-bets-sum-badge"),x=o.querySelector("#edit-hook-warning"),w=o.querySelector("#btn-save-edit-deal");if(p&&(p.textContent=`${t?"\u05E1\u05DA \u05DC\u05E7\u05D9\u05D7\u05D5\u05EA":"Tricks"}: ${u}/13`,u===13?(p.style.background="rgba(16, 185, 129, 0.2)",p.style.color="#a7f3d0",p.style.borderColor="rgba(16, 185, 129, 0.4)"):(p.style.background="rgba(239, 68, 68, 0.2)",p.style.color="#fca5a5",p.style.borderColor="rgba(239, 68, 68, 0.4)")),S&&(S.textContent=`${t?"\u05E1\u05DA \u05D4\u05DB\u05E8\u05D6\u05D5\u05EA":"Bids"}: ${y}`),x&&(y===13&&i.rules.enforceHookRule?x.style.display="block":x.style.display="none"),g.forEach((f,I)=>{let E=o.querySelector(`.edit-p-score-${I}`);if(E){let C=f.score>=0?`+${f.score}`:`${f.score}`;E.textContent=C,E.style.color=f.made?"var(--success)":"var(--danger)"}}),w){let f=u===13;w.disabled=!f,w.style.opacity=f?"1":"0.4",w.style.cursor=f?"pointer":"not-allowed"}};o.innerHTML=`
      <div class="modal-box modal-box-wide">
        ...
        <div style="margin: 0.75rem 0 0.85rem; display: flex; align-items: center; justify-content: space-between; gap: 8px; background: rgba(0,0,0,0.2); padding: 8px 12px; border-radius: var(--radius-md); border: 1px solid var(--border-subtle);">
          ...
          <select id="edit-deal-dealer" class="select-field" style="width: auto; margin-bottom: 0; padding: 4px 8px; font-size: 0.82rem;">
            ${i.players.map((u,y)=>`
              <option value="${y}" ${y===a?"selected":""}>${u.name}</option>
            `).join("")}
          </select>
        </div>
            ...
            <div class="edit-deal-player-row" style="display: flex; align-items: center; justify-content: space-between; padding: 8px 10px; background: rgba(0,0,0,0.25); border-radius: var(--radius-md); border: 1px solid var(--border-subtle);">
              ...
              <div style="display: flex; align-items: center; gap: 8px;">
                <div style="display: flex; align-items: center; gap: 4px;">
                  ...
                  <input type="number" min="0" max="13" class="input-field edit-deal-bid" data-p-idx="${y}" value="${r[y]}" style="width: 48px; margin-bottom: 0; padding: 4px; text-align: center; font-size: 0.85rem; font-weight: 700;" />
                </div>

                <div style="display: flex; align-items: center; gap: 4px;">
                  <span style="font-size: 0.7rem; color: var(--text-muted); font-weight: 700;">T:</span>
                  <input type="number" min="0" max="13" class="input-field edit-deal-trick" data-p-idx="${y}" value="${l[y]}" style="width: 48px; margin-bottom: 0; padding: 4px; text-align: center; font-size: 0.85rem; font-weight: 700;" />
                </div>
