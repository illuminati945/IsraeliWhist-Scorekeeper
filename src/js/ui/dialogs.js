/**
 * Modals & Dialogs (New Game, Rules, Stats, Export)
 */
    ...
    modal.innerHTML = `
      <div class="modal-box">
        <div class="modal-head">
          <h3 style="font-size: 1.1rem; font-weight: 700;">New Game</h3>
        ...
        <select class="select-field" id="new-game-target-select">
          <option value="UNLIMITED">Free Play (Unlimited Rounds)</option>
          <option value="13_ROUNDS">13 Rounds</option>
          <option value="16_ROUNDS">16 Rounds (4 Deals per Player)</option>
